...
import { H as t, K as n, U as r, a as i, c as a, s as o, v as s, w as c, x as l, y as u } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { p as d } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as f } from "./rough.esm-DXYGHN3m.js";
import { f as p } from "./mermaid.core-BCAu6WR7.js";
...
var h = m, g = class {
...
}, _ = 14, v = 250, y = 30, b = 60, x = 5, S = 82 * Math.PI / 180, C = Math.cos(S), w = Math.sin(S), T = /* @__PURE__ */ e((e, t, n) => {
	let r = e.node().getBBox(), i = r.width + t * 2, o = r.height + t * 2;
	a(e, o, i, n), e.attr("viewBox", `${r.x - t} ${r.y - t} ${i} ${o}`);
}, "applyPaddedViewBox"), E = /* @__PURE__ */ e((e, t, n, r) => {
	let i = r.db.getRoot();
	if (!i) return;
	let a = l(), { look: o, handDrawnSeed: s, themeVariables: c } = a, u = d(a.fontSize)[0] ?? _, m = o === "handDrawn", h = i.children ?? [], g = a.ishikawa?.diagramPadding ?? 20, y = a.ishikawa?.useMaxWidth ?? !1, b = p(t), x = b.append("g").attr("class", "ishikawa"), S = m ? f.svg(b.node()) : void 0, C = S ? {
		roughSvg: S,
		seed: s ?? 0,
	...
	let E = 0, k = v, A = m ? void 0 : L(x, E, k, E, k, "ishikawa-spine");
	if (O(x, E, k, i.text, u, C), !h.length) {
		m && L(x, E, k, E, k, "ishikawa-spine", C), T(b, g, y);
		return;
	}
	E -= 20;
	let j = h.filter((e, t) => t % 2 == 0), N = h.filter((e, t) => t % 2 == 1), P = D(j), F = D(N), I = P.total + F.total, R = v, z = v;
	if (I > 0) {
		let e = v * 2, t = v * .3;
		R = Math.max(t, e * (P.total / I)), z = Math.max(t, e * (F.total / I));
	}
	let B = u * 2;
	R = Math.max(R, P.max * B), z = Math.max(z, F.max * B), k = Math.max(R, v), A && A.attr("y1", k).attr("y2", k), x.select(".ishikawa-head-group").attr("transform", `translate(0,${k})`);
	...
	for (let e = 0; e < V; e++) {
		...
		E = t.selectAll("text").nodes().reduce((e, t) => Math.min(e, t.getBBox().x), Infinity);
	}
...
}, "sideStats"), O = /* @__PURE__ */ e((e, t, n, r, i, a) => {
	let o = Math.max(6, Math.floor(110 / (i * .6))), s = e.append("g").attr("class", "ishikawa-head-group").attr("transform", `translate(${t},${n})`), c = F(s, P(r, o), 0, 0, "ishikawa-head-label", "start", i), l = c.node().getBBox(), u = Math.max(60, l.width + 6), d = Math.max(40, l.height * 2 + 40), f = `M 0 ${-d / 2} L 0 ${d / 2} Q ${u * 2.4} 0 0 ${-d / 2} Z`;
	if (a) {
...
}, "flattenTree"), A = /* @__PURE__ */ e((e, t, n, r, i, a, o) => {
	let s = e.append("g").attr("class", "ishikawa-label-group"), c = F(s, t, n, r + 11 * i, "ishikawa-label cause", "middle", a).node().getBBox();
	if (o) {
...
}, "drawCauseLabel"), j = /* @__PURE__ */ e((e, t, n, r, i, a) => {
	...
	e.append(() => m);
}, "drawArrowMarker"), M = /* @__PURE__ */ e((e, t, n, r, i, a, o, s) => {
	let c = t.children ?? [], l = a * (c.length ? 1 : .2), u = -C * l, d = w * l * i, f = n + u, p = r + d;
	if (L(e, n, r, f, p, "ishikawa-branch", s), s && j(e, n, r, n - f, r - p, s), A(e, t.text, f, p, i, o, s), !c.length) return;
	let { entries: m, yOrder: h } = k(c, i), g = m.length, _ = Array(g);
	...
	let S = -C, T = w * i, E = i < 0 ? "ishikawa-label up" : "ishikawa-label down";
	for (let [t, n] of m.entries()) {
		let r = _[t], i = v.get(n.parentIndex), a = e.append("g").attr("class", "ishikawa-sub-group"), c = 0, l = 0, u = 0;
		if (n.depth % 2 == 0) {
			let e = i.y1 - i.y0;
			c = I(i.x0, i.x1, e ? (r - i.y0) / e : .5), l = r, u = c - (n.childCount > 0 ? b + n.childCount * x : y), L(a, c, r, u, r, "ishikawa-sub-branch", s), s && j(a, c, r, 1, 0, s), F(a, n.text, u, r, "ishikawa-label align", "end", o);
		} else {
			let e = i.childrenDrawn++;
			c = I(i.x0, i.x1, (i.childCount - e) / (i.childCount + 1)), l = i.y0, u = c + S * ((r - l) / T), L(a, c, l, u, r, "ishikawa-sub-branch", s), s && j(a, c, l, c - u, l - r, s), F(a, n.text, u, r, E, "end", o);
		}
...
}, "drawBranch"), N = /* @__PURE__ */ e((e) => e.split(/<br\s*\/?>|\n/), "splitLines"), P = /* @__PURE__ */ e((e, t) => {
	...
	return n.join("\n");
}, "wrapText"), F = /* @__PURE__ */ e((e, t, n, r, i, a, o) => {
	let s = N(t), c = o * 1.05, l = e.append("text").attr("class", i).attr("text-anchor", a).attr("x", n).attr("y", r - (s.length - 1) * c / 2);
	for (let [e, t] of s.entries()) l.append("tspan").attr("x", n).attr("dy", e === 0 ? 0 : c).text(t);
	return l;
}, "drawMultilineText"), I = /* @__PURE__ */ e((e, t, n) => e + (t - e) * n, "lerp"), L = /* @__PURE__ */ e((e, t, n, r, i, a, o) => {
	if (o) {
...
//# sourceMappingURL=ishikawaDiagram-5VMMS53U-_2UvgvEX.js.map