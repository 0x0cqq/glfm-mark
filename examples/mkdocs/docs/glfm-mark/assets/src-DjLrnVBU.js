...
function pe() {
	return new O(this._enter || this._groups.map(fe), this._parents);
}
function me(e, t) {
...
function xe() {
	return new O(this._exit || this._groups.map(fe), this._parents);
}
//#endregion
...
function We(e, t, n) {
	return arguments.length > 1 ? this.each((t == null ? Ve : typeof t == "function" ? Ue : He)(e, t, n ?? "")) : D(this.node(), e);
}
function D(e, t) {
...
function vt(e, t) {
	var n = typeof e == "function" ? e : y(e), r = t == null ? _t : typeof t == "function" ? t : x(t);
	return this.select(function() {
...
function k() {
	return new O([[document.documentElement]], Ft);
}
function It() {
	return this;
}
...
function Lt(e) {
	return typeof e == "string" ? new O([[document.querySelector(e)]], [document.documentElement]) : new O([[e]], Ft);
}
//#endregion
...
function A() {}
var j = .7, M = 1 / j, N = "\\s*([+-]?\\d+)\\s*", P = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", F = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", Bt = /^#([0-9a-f]{3,8})$/, Vt = RegExp(`^rgb\\(${N},${N},${N}\\)$`), Ht = RegExp(`^rgb\\(${F},${F},${F}\\)$`), Ut = RegExp(`^rgba\\(${N},${N},${N},${P}\\)$`), Wt = RegExp(`^rgba\\(${F},${F},${F},${P}\\)$`), Gt = RegExp(`^hsl\\(${P},${F},${F}\\)$`), Kt = RegExp(`^hsla\\(${P},${F},${F},${P}\\)$`), qt = {
	aliceblue: 15792383,
...
function I(e) {
	var t, n;
	return e = (e + "").trim().toLowerCase(), (t = Bt.exec(e)) ? (n = t[1].length, t = parseInt(t[1], 16), n === 6 ? Qt(t) : n === 3 ? new L(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : n === 8 ? $t(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : n === 4 ? $t(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = Vt.exec(e)) ? new L(t[1], t[2], t[3], 1) : (t = Ht.exec(e)) ? new L(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = Ut.exec(e)) ? $t(t[1], t[2], t[3], t[4]) : (t = Wt.exec(e)) ? $t(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = Gt.exec(e)) ? sn(t[1], t[2] / 100, t[3] / 100, 1) : (t = Kt.exec(e)) ? sn(t[1], t[2] / 100, t[3] / 100, t[4]) : qt.hasOwnProperty(e) ? Qt(qt[e]) : e === "transparent" ? new L(NaN, NaN, NaN, 0) : null;
}
function Qt(e) {
...
function en(e) {
	return e instanceof A || (e = I(e)), e ? (e = e.rgb(), new L(e.r, e.g, e.b, e.opacity)) : new L();
}
function tn(e, t, n, r) {
	return arguments.length === 1 ? en(e) : new L(e, t, n, r ?? 1);
}
function L(e, t, n, r) {
...
Rt(L, tn, zt(A, {
	...
	clamp() {
		return new L(R(this.r), R(this.g), R(this.b), on(this.opacity));
	},
	displayable() {
...
function cn(e) {
	...
	if (e instanceof A || (e = I(e)), !e) return new B();
...
function ln(e, t, n, r) {
	return arguments.length === 1 ? cn(e) : new B(e, t, n, r ?? 1);
}
function B(e, t, n, r) {
...
Rt(B, ln, zt(A, {
	brighter(e) {
		return e = e == null ? M : M ** +e, new B(this.h, this.s, this.l * e, this.opacity);
	},
	darker(e) {
		return e = e == null ? j : j ** +e, new B(this.h, this.s, this.l * e, this.opacity);
	},
	rgb() {
		var e = this.h % 360 + (this.h < 0) * 360, t = isNaN(e) || isNaN(this.s) ? 0 : this.s, n = this.l, r = n + (n < .5 ? n : 1 - n) * t, i = 2 * n - r;
		return new L(dn(e >= 240 ? e - 240 : e + 120, i, r), dn(e, i, r), dn(e < 120 ? e + 240 : e - 120, i, r), this.opacity);
	},
	clamp() {
		return new B(un(this.h), V(this.s), V(this.l), on(this.opacity));
	},
	displayable() {
	...
	formatHsl() {
		let e = on(this.opacity);
		return `${e === 1 ? "hsl(" : "hsla("}${un(this.h)}, ${V(this.s) * 100}%, ${V(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
	}
}));
function un(e) {
...
function mn(e, t) {
	var n = t - e;
	return n ? fn(e, n > 180 || n < -180 ? n - 360 * Math.round(n / 360) : n) : H(isNaN(e) ? t : e);
}
function hn(e) {
	return (e = +e) == 1 ? gn : function(t, n) {
		return n - t ? pn(t, n, e) : H(isNaN(t) ? n : t);
	};
}
function gn(e, t) {
	var n = t - e;
	return n ? fn(e, n) : H(isNaN(e) ? t : e);
}
//#endregion
...
var _n = (function e(t) {
	var n = hn(t);
	function r(e, t) {
		var r = n((e = tn(e)).r, (t = tn(t)).r), i = n(e.g, t.g), a = n(e.b, t.b), o = gn(e.opacity, t.opacity);
		return function(t) {
...
var vn = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, yn = new RegExp(vn.source, "g");
function bn(e) {
	return function() {
		return e;
	};
...
function Sn(e, t) {
	var n = vn.lastIndex = yn.lastIndex = 0, r, i, a, o = -1, s = [], c = [];
	for (e += "", t += ""; (r = vn.exec(e)) && (i = yn.exec(t));) (a = i.index) > n && (a = t.slice(n, a), s[o] ? s[o] += a : s[++o] = a), (r = r[0]) === (i = i[0]) ? s[o] ? s[o] += i : s[++o] = i : (s[++o] = null, c.push({
		i: o,
		x: U(r, i)
	})), n = yn.lastIndex;
	return n < t.length && (a = t.slice(n), s[o] ? s[o] += a : s[++o] = a), s.length < 2 ? c[0] ? xn(c[0].x) : bn(t) : (t = c.length, function(e) {
...
function Dn(e) {
	...
	return t.isIdentity ? wn : Tn(t.a, t.b, t.c, t.d, t.e, t.f);
}
function On(e) {
	return e == null || (En ||= document.createElementNS("http://www.w3.org/2000/svg", "g"), En.setAttribute("transform", e), !(e = En.transform.baseVal.consolidate())) ? wn : (e = e.matrix, Tn(e.a, e.b, e.c, e.d, e.e, e.f));
}
//#endregion
...
var An = kn(Dn, "px, ", "px)", "deg)"), jn = kn(On, ", ", ")", ")"), W = 0, G = 0, Mn = 0, Nn = 1e3, Pn, K, Fn = 0, q = 0, In = 0, J = typeof performance == "object" && performance.now ? performance : Date, Ln = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
	setTimeout(e, 17);
};
function Rn() {
	return q ||= (Ln(zn), J.now() + In);
}
function zn() {
	q = 0;
}
...
Bn.prototype = Vn.prototype = {
	...
	restart: function(e, t, n) {
		...
		n = (n == null ? Rn() : +n) + (t == null ? 0 : +t), !this._next && K !== this && (K ? K._next = this : Pn = this, K = this), this._call = e, this._time = n, Kn();
	},
	stop: function() {
		this._call && (this._call = null, this._time = Infinity, Kn());
	}
};
function Vn(e, t, n) {
	var r = new Bn();
...
function Hn() {
	Rn(), ++W;
	for (var e = Pn, t; e;) (t = q - e._time) >= 0 && e._call.call(void 0, t), e = e._next;
	--W;
}
function Un() {
	q = (Fn = J.now()) + In, W = G = 0;
...
function Gn() {
	for (var e, t = Pn, n, r = Infinity; t;) t._call ? (r > t._time && (r = t._time), e = t, t = t._next) : (n = t._next, t._next = null, t = e ? e._next = n : Pn = n);
	K = e, Kn(r);
}
function Kn(e) {
	W || (G &&= clearTimeout(G), e - q > 24 ? (e < Infinity && (G = setTimeout(Un, e - J.now() - In)), Mn &&= clearInterval(Mn)) : (Mn ||= (Fn = J.now(), setInterval(Wn, Nn)), W = 1, Ln(Un)));
}
//#endregion
...
var Jn = u("start", "end", "cancel", "interrupt"), Yn = [];
...
function ar(e, t) {
	var n;
	return (typeof t == "number" ? U : t instanceof I ? _n : (n = I(t)) ? (t = n, _n) : Sn)(e, t);
}
//#endregion
...
function Fr(e) {
	...
	typeof e != "function" && (e = x(e));
	for (var r = this._groups, i = r.length, a = Array(i), o = 0; o < i; ++o) for (var s = r[o], c = s.length, l = a[o] = Array(c), u, d, f = 0; f < c; ++f) (u = s[f]) && (d = e.call(u, u.__data__, f, s)) && ("__data__" in u && (d.__data__ = u.__data__), l[f] = d, Xn(l[f], t, n, f, l, X(u, n)));
...
function Ir(e) {
	...
	for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s) for (var c = r[s], l = c.length, u, d = 0; d < l; ++d) if (u = c[d]) {
		for (var f = e.call(u, u.__data__, d, c), p, m = X(u, n), h = 0, g = f.length; h < g; ++h) (p = f[h]) && Xn(p, t, n, h, f, m);
		a.push(f), o.push(u);
	}
...
var Lr = k.prototype.constructor;
function Rr() {
...
function Ur(e, t) {
	...
	return function() {
		var c = Y(this, e), l = c.on, u = c.value[a] == null ? s ||= Br(t) : void 0;
		(l !== n || i !== u) && (r = (n = l).copy()).on(o, i = u), c.on = r;
	};
}
function Wr(e, t, n) {
	var r = (e += "") == "transform" ? An : ar;
...
function si(e) {
	var t, n;
	e instanceof Z ? (t = e._id, e = e._name) : (t = ri(), (n = ai).time = Rn(), e = e == null ? null : e + "");
	for (var r = this._groups, i = r.length, a = 0; a < i; ++a) for (var o = r[a], s = o.length, c, l = 0; l < s; ++l) (c = o[l]) && Xn(c, e, t, l, o, n || oi(c, t));
	return new Z(r, this._parents, e, t);
}
k.prototype.interrupt = er, k.prototype.transition = si;
//#endregion
...
//#endregion
export { gn as a, L as c, Rt as d, zt as f, r as g, s as h, mn as i, I as l, o as m, U as n, H as o, Lt as p, _n as r, A as s, Sn as t, en as u };

//# sourceMappingURL=src-DjLrnVBU.js.map