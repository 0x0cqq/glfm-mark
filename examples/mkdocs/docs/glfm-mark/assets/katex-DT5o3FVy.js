...
an({
	...
	htmlBuilder(t, n) {
		if (Bi.hasOwnProperty(t.text)) {
			...
			return W(["mspace", r], [Pt(t.text, t.mode, n)], n);
		}
		if (zi.hasOwnProperty(t.text)) return W(["mspace", zi[t.text]], [], n);
...
//# sourceMappingURL=katex-DT5o3FVy.js.map