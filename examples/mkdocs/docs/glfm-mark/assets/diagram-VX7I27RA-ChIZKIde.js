...
import { D as i, H as a, K as o, U as s, a as c, b as l, c as u, f as d, v as f, w as p, y as m } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { t as h } from "./ordinal-BubEveRk.js";
import { t as g } from "./defaultLocale-N-0uLSyg.js";
import { i as _ } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as v } from "./chunk-JWPE2WC7-Ccb0QaC8.js";
import { i as y, n as b } from "./chunk-P2QGCYS3-BgBZ7Zuo.js";
import { t as x } from "./chunk-POPQ4Y6H-BFKrin2m.js";
import { f as S } from "./mermaid.core-BCAu6WR7.js";
...
var se = /* @__PURE__ */ t((e, n) => {
	...
	let i = Y(r), a = /* @__PURE__ */ t((e, t) => {
		for (let r of e) n.addNode(r, t), r.children && r.children.length > 0 && a(r.children, t + 1);
	}, "addNodesRecursively");
	a(i, 0);
}, "populate"), ce = /* @__PURE__ */ t((e) => e.name ? String(e.name) : "", "getItemName"), X = {
	parser: { yy: void 0 },
	parse: /* @__PURE__ */ t(async (t) => {
		try {
			...
			let i = X.parser?.yy;
			if (!(i instanceof J)) throw Error("parser.parser?.yy was not a TreemapDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
			se(r, i);
		} catch (e) {
	...
	draw: /* @__PURE__ */ t((e, i, a, o) => {
		let s = o.db, c = s.getConfig(), d = c.padding ?? Z, f = s.getDiagramTitle(), p = s.getRoot(), { themeVariables: m } = l();
		if (!p) return;
	...
	styles: /* @__PURE__ */ t(({ treemap: e } = {}) => {
		let t = i(), n = l(), r = _(t, n.themeVariables), a = _(ue, e), o = a.titleColor ?? r.titleColor, s = a.labelColor ?? r.textColor, c = a.valueColor ?? r.textColor;
		return `
  .treemapNode.section {
...
//# sourceMappingURL=diagram-VX7I27RA-ChIZKIde.js.map