...
import { A as r, F as i, G as a, H as o, K as s, O as c, U as l, a as u, b as d, c as f, i as p, r as m, s as h, v as g, w as _, x as v, y, z as b } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { t as x } from "./dist-CkY22sKw.js";
import { g as S, p as C } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { a as w, c as T, i as E, n as D, r as O, s as k } from "./chunk-F27PBJKO-DanGKZor.js";
import { t as A } from "./chunk-2Q5K7J3B-kzxEEeTu.js";
import { n as j, t as M } from "./mermaid.core-BCAu6WR7.js";
...
var N = x(), P = (function() {
	var t = /* @__PURE__ */ e(function(e, t, n, r) {
		...
		64,
		73
	], ee = [1, 74], L = [1, 80], R = [1, 81], te = [1, 82], ne = [1, 83], z = [1, 84], B = [1, 85], V = [1, 86], re = [1, 87], H = [1, 88], U = [1, 89], W = [1, 90], ie = [1, 91], ae = [1, 92], oe = [1, 93], G = [1, 94], se = [1, 95], K = [1, 96], ce = [1, 97], le = [1, 98], ue = [1, 99], de = [1, 100], fe = [1, 101], pe = [1, 102], me = [1, 103], he = [1, 104], ge = [1, 105], _e = [2, 78], ve = [
		4,
		5,
		17,
		51,
...
var F = P, I = {
	...
	constructor() {
		...
		})), this.setAccTitle = l, this.setAccDescription = o, this.setDiagramTitle = s, this.getAccTitle = y, this.getAccDescription = g, this.getDiagramTitle = _, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap(v().wrap), this.LINETYPE = I, this.ARROWTYPE = ee, this.PLACEMENT = L;
	}
	static {
		e(this, "SequenceDB");
	}
...
`;
...
}, "fixLifeLineHeights"), le = /* @__PURE__ */ e(function(e, t, n, i, a) {
	...
	return b;
}, "drawActorTypeParticipant"), ue = /* @__PURE__ */ e(function(e, t, n, i, a) {
	let o = i ? t.stopy : t.starty, s = t.x + t.width / 2, c = o + t.height, { look: l, theme: u, themeVariables: d } = n, { bkgColorArray: f, borderColorArray: p } = d, m = e.append("g").lower();
	var h = m;
	i || (K++, Object.keys(t.links || {}).length && !n.forceMenus && h.attr("onclick", ae(`actor${K}_popup`)).attr("cursor", "pointer"), h.append("line").attr("id", "actor" + K).attr("x1", s).attr("y1", c).attr("x2", s).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), h = m.append("g"), t.actorCnt = K, t.links != null && h.attr("id", "root-" + K), l === "neo" && h.attr("data-look", "neo"));
	let g = k();
...
}, "drawActorTypeCollections"), de = /* @__PURE__ */ e(function(e, t, n, i, a) {
...
}, "drawActorTypeQueue"), fe = /* @__PURE__ */ e(function(e, t, n, i, a, o) {
...
}, "drawActorTypeControl"), pe = /* @__PURE__ */ e(function(e, t, n, i, a) {
...
}, "drawActorTypeEntity"), me = /* @__PURE__ */ e(function(e, t, n, i, a) {
...
}, "drawActorTypeDatabase"), he = /* @__PURE__ */ e(function(e, t, n, i, a) {
...
}, "drawActorTypeBoundary"), ge = /* @__PURE__ */ e(function(e, t, n, i, a) {
...
}, "drawActivation"), xe = /* @__PURE__ */ e(async function(t, n, i, a, o) {
...
e(Le, "boundMessage");
var Re = /* @__PURE__ */ e(async function(e, t, n, i, a, o) {
...
}, "drawMessage"), ze = /* @__PURE__ */ e(function(e, t, n, r, i, a, o) {
	let s = 0, c = 0, l, u = 0;
	for (let e of r) {
...
}, "addActorRenderingData"), Be = /* @__PURE__ */ e(async function(e, t, n, r, i, a, o) {
	if (r) {
		let r = 0;
...
var Ke = /* @__PURE__ */ e(async function(r, i, a, o) {
	...
	Q.init(), t.debug(o.db);
	let h = s === "sandbox" ? p.select(`[id="${i}"]`) : n(`[id="${i}"]`), g = o.db.getActors(), _ = o.db.getCreatedActors(), y = o.db.getDestroyedActors(), b = o.db.getBoxes(), x = o.db.getActorKeys(), S = o.db.getMessages(), C = o.db.getDiagramTitle(), w = o.db.hasAtLeastOneBox(), T = o.db.hasAtLeastOneBoxWithTitle(), E = await qe(g, S, o);
	if (Z.height = await Ye(g, E, b), X.insertComputerIcon(h, i), X.insertDatabaseIcon(h, i), X.insertClockIcon(h, i), w && (Q.bumpVerticalPos(Z.boxMargin), T && Q.bumpVerticalPos(b[0].textMaxHeight)), Z.hideUnusedParticipants === !0) {
	...
	function k(e, t) {
		...
		n.starty + 18 > t && (n.starty = t - 6, t += 12), X.drawActivation(h, n, t, Z, Ue(e.from).length, o, D), Q.insert(n.startx, t - 10, n.stopx, t);
	}
	e(k, "activeEnd");
	let A = 1, j = 1, M = [], N = [], P = 0;
	for (let e of S) {
		...
		switch (e.type) {
			case o.db.LINETYPE.NOTE:
				Q.resetVerticalPos(), r = e.noteModel, await Me(h, r, e.id);
				break;
			...
			case o.db.LINETYPE.RECT_START:
				$(O, e, Z.boxMargin, Z.boxMargin, (e) => {
					let t = e.message;
					t ||= u?.rectBkgColor || u?.actorBkg || "rgba(128, 128, 128, 0.5)", Q.newLoop(void 0, t);
				});
				break;
	...
	t.debug("createdActors", _), t.debug("destroyedActors", y), await Be(h, g, x, !1, i, o, D);
	for (let e of M) await Re(h, e.messageModel, e.lineStartY, o, e.msg, i);
	Z.mirrorActors && await Be(h, g, x, !0, i, o, D), N.forEach((e) => X.drawBackgroundRect(h, e)), ce(h, g, x, Z);
	...
	let F = Ve(h, g, x, m), { bounds: I } = Q.getBounds();
	...
	let R = I.stopx - I.startx;
	R < F.maxWidth && (R = F.maxWidth);
	let te = R + 2 * Z.diagramMarginX;
	C && h.append("text").text(C).attr("x", (I.stopx - I.startx) / 2 - 2 * Z.diagramMarginX).attr("y", -25), f(h, L, te, Z.useMaxWidth);
	let ne = C ? 40 : 0, z = g.size && l === "neo" ? 30 : 0;
	h.attr("viewBox", I.startx - Z.diagramMarginX + " -" + (Z.diagramMarginY + ne) + " " + te + " " + (L + ne + z)), t.debug("models:", Q.models);
}, "draw");
async function qe(e, n, i) {
	...
	for (let t of n) if (e.get(t.to) && e.get(t.from)) {
		...
		let o = t.placement !== void 0, s = !o, c = o ? Fe(Z) : Pe(Z), l = t.wrap ? S.wrapLabel(t.message, Z.width - 2 * Z.wrapPadding, c) : t.message, u = (r(l) ? await p(t.message, v()) : S.calculateTextDimensions(l, c)).width + 2 * Z.wrapPadding;
...
var Xe = /* @__PURE__ */ e(async function(e, n, i) {
	let a = n.get(e.from), o = n.get(e.to), s = a.x, c = o.x, l = e.wrap && e.message, u = r(e.message) ? await p(e.message, v()) : S.calculateTextDimensions(l ? S.wrapLabel(e.message, Z.width, Fe(Z)) : e.message, Fe(Z)), d = {
	...
	return e.placement === i.db.PLACEMENT.RIGHTOF ? (d.width = l ? h.getMax(Z.width, u.width) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s + (a.width + Z.actorMargin) / 2) : e.placement === i.db.PLACEMENT.LEFTOF ? (d.width = l ? h.getMax(Z.width, u.width + 2 * Z.noteMargin) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s - d.width + (a.width - Z.actorMargin) / 2) : e.to === e.from ? (u = S.calculateTextDimensions(l ? S.wrapLabel(e.message, h.getMax(Z.width, a.width), Fe(Z)) : e.message, Fe(Z)), d.width = l ? h.getMax(Z.width, a.width) : h.getMax(a.width, Z.width, u.width + 2 * Z.noteMargin), d.startx = s + (a.width - d.width) / 2) : (d.width = Math.abs(s + a.width / 2 - (c + o.width / 2)) + Z.actorMargin, d.startx = s < c ? s + a.width / 2 - Z.actorMargin / 2 : c + o.width / 2 - Z.actorMargin / 2), l && (d.message = S.wrapLabel(e.message, d.width - 2 * Z.wrapPadding, Fe(Z))), t.debug(`NM:[${d.startx},${d.stopx},${d.starty},${d.stopy}:${d.width},${d.height}=${e.message}]`), d;
	...
	let [a, o] = We(t.from, n), [s, c] = We(t.to, n), l = a <= s, u = l ? o : a, d = l ? s : c;
	i === "neo" && (t.type !== r.db.LINETYPE.SOLID_OPEN && (d += l ? -3 : 3), (t.type === r.db.LINETYPE.BIDIRECTIONAL_SOLID || t.type === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (u += l ? 3 : -3)), u += et(t, r, l);
	...
	t.wrap && t.message && (t.message = S.wrapLabel(t.message, h.getMax(g + 2 * Z.wrapPadding, Z.width), Pe(Z)));
	let _ = S.calculateTextDimensions(t.message, Pe(Z));
	return {
	...
	for (let t of e) {
		...
		t.placement === void 0 ? (l = rt(t, n, i), t.msgModel = l, l.startx && l.stopx && o.length > 0 && o.forEach((e) => {
		...
		})) : (c = await Xe(t, n, i), t.noteModel = c, o.forEach((e) => {
...
//# sourceMappingURL=sequenceDiagram-WJ2MYXX4-BLHaYjJH.js.map