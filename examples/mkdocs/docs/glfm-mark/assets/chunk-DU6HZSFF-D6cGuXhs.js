...
import { n as t, t as n } from "./chunk-Y2CYZVJY-i11wjrBe.js";
import { h as r, m as i } from "./src-DjLrnVBU.js";
...
var c = {
...
}, w = /* @__PURE__ */ t((e, t, { depth: n = 2 } = {}) => {
	let r = { depth: n };
	if (Array.isArray(t) && !Array.isArray(e)) return t.forEach((t) => w(e, t, r)), e;
		...
		Object.entries(t).forEach(([t, i]) => {
			if (typeof i == "object") {
				...
				Object.hasOwn(e, t) || Object.defineProperty(e, t, {
					...
					enumerable: !0,
					configurable: !0
				}), r[t] === void 0 && (r[t] = Array.isArray(i) ? [] : {}), typeof r[t] == "object" && (r[t] = w(r[t], i, { depth: n - 1 }));
	...
	return e;
}, "assignWithDepth"), T = w, E = "#ffffff", D = "#f2f2f2", O = /* @__PURE__ */ t((e, t) => t ? S(e, {
	s: -40,
	l: 10
}) : S(e, {
	s: -40,
	...
	constructor() {
		this.background = "#ffffff", this.primaryColor = "#cccccc", this.mainBkg = "#ffffff", this.noteBkgColor = "#fff5ad", this.noteTextColor = "#333", this.THEME_COLOR_LIMIT = 12, this.radius = 3, this.strokeWidth = 2, this.primaryBorderColor = O(this.primaryColor, this.darkMode), this.fontFamily = "arial, sans-serif", this.fontSize = "14px", this.nodeBorder = "#000000", this.stateBorder = "#000000", this.useGradient = !0, this.gradientStart = "#0042eb", this.gradientStop = "#eb0042", this.dropShadow = "drop-shadow( 0px 1px 2px rgba(0, 0, 0, 0.25));", this.tertiaryColor = "#ffffff", this.archEdgeColor = "calculated", this.archEdgeArrowColor = "calculated", this.archEdgeWidth = "3", this.archGroupBorderColor = this.primaryBorderColor, this.archGroupBorderWidth = "2px", this.noteFontWeight = "normal", this.fontWeight = "normal";
	}
	updateColors() {
	...
	constructor() {
		this.background = "#ffffff", this.primaryColor = "#cccccc", this.mainBkg = "#ffffff", this.noteBkgColor = "#fff5ad", this.noteTextColor = "#28253D", this.THEME_COLOR_LIMIT = 12, this.radius = 12, this.strokeWidth = 2, this.primaryBorderColor = O(this.primaryColor, this.darkMode), this.fontFamily = "\"Recursive Variable\", arial, sans-serif", this.fontSize = "14px", this.nodeBorder = "#28253D", this.stateBorder = "#28253D", this.useGradient = !1, this.gradientStart = "#0042eb", this.gradientStop = "#eb0042", this.dropShadow = "url(#drop-shadow)", this.nodeShadow = !0, this.tertiaryColor = "#ffffff", this.archEdgeColor = "calculated", this.archEdgeArrowColor = "calculated", this.archEdgeWidth = "3", this.archGroupBorderColor = this.primaryBorderColor, this.archGroupBorderWidth = "2px", this.actorBorder = "#28253D", this.noteBorderColor = "#FACC15", this.noteFontWeight = 600, this.borderColorArray = [
			"#E879F9",
			"#2DD4BF",
			"#FB923C",
			"#22D3EE",
	...
	updateColors() {
		this.primaryTextColor = this.primaryTextColor || (this.darkMode ? "#eee" : "#28253D"), this.secondaryColor = this.secondaryColor || S(this.primaryColor, { h: -120 }), this.tertiaryColor = this.tertiaryColor || S(this.primaryColor, {
			h: 180,
			l: 5
		}), this.primaryBorderColor = this.primaryBorderColor || O(this.primaryColor, this.darkMode), this.secondaryBorderColor = this.secondaryBorderColor || O(this.secondaryColor, this.darkMode), this.tertiaryBorderColor = this.tertiaryBorderColor || O(this.tertiaryColor, this.darkMode), this.noteBorderColor = this.noteBorderColor || O(this.noteBkgColor, this.darkMode), this.noteBkgColor = this.noteBkgColor || "#fff5ad", this.noteTextColor = this.noteTextColor || "#28253D", this.secondaryTextColor = this.secondaryTextColor || C(this.secondaryColor), this.tertiaryTextColor = this.tertiaryTextColor || C(this.tertiaryColor), this.lineColor = this.lineColor || C(this.background), this.arrowheadColor = this.arrowheadColor || C(this.background), this.textColor = this.textColor || this.primaryTextColor, this.border2 = this.border2 || this.tertiaryBorderColor, this.nodeBkg = this.nodeBkg || this.primaryColor, this.mainBkg = this.mainBkg || this.primaryColor, this.nodeBorder = this.nodeBorder || this.primaryBorderColor, this.clusterBkg = this.clusterBkg || this.tertiaryColor, this.clusterBorder = this.clusterBorder || this.tertiaryBorderColor, this.defaultLinkColor = this.defaultLinkColor || this.lineColor, this.titleColor = this.titleColor || this.tertiaryTextColor, this.edgeLabelBackground = this.edgeLabelBackground || (this.darkMode ? x(this.secondaryColor, 30) : this.secondaryColor), this.nodeTextColor = this.nodeTextColor || this.primaryTextColor, this.actorBorder = this.actorBorder || this.primaryBorderColor, this.actorBkg = this.actorBkg || this.mainBkg, this.actorTextColor = this.actorTextColor || this.primaryTextColor, this.actorLineColor = this.actorLineColor || this.actorBorder, this.labelBoxBkgColor = this.labelBoxBkgColor || this.actorBkg, this.signalColor = this.signalColor || this.textColor, this.signalTextColor = this.signalTextColor || this.textColor, this.labelBoxBorderColor = this.labelBoxBorderColor || this.actorBorder, this.labelTextColor = this.labelTextColor || this.actorTextColor, this.loopTextColor = this.loopTextColor || this.actorTextColor, this.activationBorderColor = this.activationBorderColor || x(this.secondaryColor, 10), this.activationBkgColor = this.activationBkgColor || this.secondaryColor, this.sequenceNumberColor = this.sequenceNumberColor || C(this.lineColor), this.rectBkgColor = this.rectBkgColor || this.tertiaryColor;
		let e = "#ECECFE", t = "#E9E9F1", n = S(e, {
			h: 180,
			l: 5
		});
	...
	base: { getThemeVariables: ie },
	dark: { getThemeVariables: oe },
	default: { getThemeVariables: ce },
	forest: { getThemeVariables: ue },
	neutral: { getThemeVariables: fe },
	neo: { getThemeVariables: me },
	"neo-dark": { getThemeVariables: ge },
	redux: { getThemeVariables: ve },
	"redux-dark": { getThemeVariables: be },
	"redux-color": { getThemeVariables: Se },
	...
	venn: { ...A.venn },
	cynefin: { ...A.cynefin }
}, Te = /* @__PURE__ */ t((e, t = "") => Object.keys(e).reduce((n, r) => Array.isArray(e[r]) ? n : typeof e[r] == "object" && e[r] !== null ? [
	...n,
	t + r,
	...Te(e[r], "")
] : [...n, t + r], []), "keyify"), Ee = new Set(Te(we, "")), De = we, Oe = {
...
}, "sanitizeDictionaryConfig"), j = /* @__PURE__ */ t((e) => {
	if (i.debug("sanitizeDirective called with", e), typeof e == "object" && e) {
		...
		for (let t of Object.keys(e)) {
			if (i.debug("Checking key", t), t.startsWith("__") || t.includes("proto") || t.includes("constr") || !Ee.has(t) || e[t] == null) {
				i.debug("sanitize deleting key: ", t), delete e[t];
				continue;
			}
			if (typeof e[t] == "object") {
				let n = Oe[t];
				n ? ke(e[t], n) : (i.debug("sanitizing object", t), j(e[t]));
				continue;
			}
			for (let n of [
				"themeCSS",
				"fontFamily",
				"altFontFamily"
			]) t.includes(n) && (i.debug("sanitizing css option", t), e[t] = Ae(e[t]));
		}
...
}, "sanitizeDirective"), Ae = /* @__PURE__ */ t((e) => {
	let t = 0, n = 0;
	for (let r of e) {
...
}, "sanitizeCss"), M = Object.freeze(De), N = /* @__PURE__ */ t((e) => !(e === !1 || [
	"false",
	"null",
	"0"
].includes(String(e).trim().toLowerCase())), "evaluate"), P = T({}, M), F, I = [], L = T({}, M), R = /* @__PURE__ */ t((e, t) => {
	let n = T({}, e), r = {};
	for (let e of t) Ie(e), r = T(r, e);
	if (n = T(n, r), r.theme && r.theme in k) {
		let e = T(T({}, F).themeVariables || {}, r.themeVariables);
		n.theme && n.theme in k && (n.themeVariables = k[n.theme].getThemeVariables(e));
	}
	return L = n, He(L), L;
}, "updateCurrentConfig"), je = /* @__PURE__ */ t((e) => (P = T({}, M), P = T(P, e), e.theme && k[e.theme] && (P.themeVariables = k[e.theme].getThemeVariables(e.themeVariables)), R(P, I), P), "setSiteConfig"), Me = /* @__PURE__ */ t((e) => {
	F = T({}, e);
}, "saveConfigFromInitialize"), Ne = /* @__PURE__ */ t((e) => (P = T(P, e), R(P, I), P), "updateSiteConfig"), Pe = /* @__PURE__ */ t(() => T({}, P), "getSiteConfig"), Fe = /* @__PURE__ */ t((e) => (R(L, [e]), z()), "setConfig"), z = /* @__PURE__ */ t(() => T({}, L), "getConfig"), Ie = /* @__PURE__ */ t((e) => {
	e && (["secure", ...P.secure ?? []].forEach((t) => {
		...
		typeof e[t] == "string" && (e[t].includes("<") || e[t].includes(">") || e[t].includes("url(data:")) && delete e[t], typeof e[t] == "object" && Ie(e[t]);
	}));
}, "sanitize"), Le = /* @__PURE__ */ t((e) => {
	j(e), e.fontFamily && !e.themeVariables?.fontFamily && (e.themeVariables = {
		...e.themeVariables,
		fontFamily: e.fontFamily
	}), I.push(e), R(P, I);
}, "addDirective"), Re = /* @__PURE__ */ t((e = P) => {
	I = [], R(e, I);
}, "reset"), ze = {
	...
	Be[e] || (i.warn(ze[e]), Be[e] = !0);
}, "issueWarning"), He = /* @__PURE__ */ t((e) => {
	e && (e.lazyLoadedDiagrams || e.loadExternalDiagramsAtStartup) && Ve("LAZY_LOAD_DEPRECATED");
}, "checkConfig"), Ue = /* @__PURE__ */ t(() => {
	let e = {};
	F && (e = T(e, F));
	for (let t of I) e = T(e, t);
	return e;
}, "getUserDefinedConfig"), We = /* @__PURE__ */ t((e) => (e.flowchart?.htmlLabels != null && Ve("FLOWCHART_HTML_LABELS_DEPRECATED"), N(e.htmlLabels ?? e.flowchart?.htmlLabels ?? !0)), "getEffectiveHtmlLabels"), Ge = /^([^\S\n\r]*)-{3}\s*[\n\r](.*?)[\n\r]\1-{3}\s*[\n\r]+/s, Ke = /%{2}{\s*(?:(\w+)\s*:|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, qe = /\s*%%.*\n/gm, Je = class extends Error {
	static {
...
}, B = {}, Ye = /* @__PURE__ */ t(function(e, t) {
	e = e.replace(Ge, "").replace(Ke, "").replace(qe, "\n");
	for (let [n, { detector: r }] of Object.entries(B)) if (r(e, t)) return n;
	throw new Je(`No diagram type detected matching given configuration for text: ${e}`);
}, "detectType"), Xe = /* @__PURE__ */ t((...e) => {
	for (let { id: t, detector: n, loader: r } of e) Ze(t, n, r);
}, "registerLazyLoadedDiagrams"), Ze = /* @__PURE__ */ t((e, t, n) => {
	B[e] && i.warn(`Detector with key ${e} already exists. Overwriting.`), B[e] = {
		detector: t,
		loader: n
	}, i.debug(`Detector with key ${e} added${n ? " with loader" : ""}`);
}, "addDetector"), Qe = /* @__PURE__ */ t((e) => B[e].loader, "getDiagramLoader"), V = /<br\s*\/?>/gi, $e = /* @__PURE__ */ t((e) => e ? ct(e).replace(/\\n/g, "#br#").split("#br#") : [""], "getRows"), et = /* @__PURE__ */ (() => {
	let e = !1;
	return () => {
		e ||= (tt(), !0);
	};
...
t(tt, "setupDompurifyHooks");
var nt = /* @__PURE__ */ t((t) => (et(), e.sanitize(t)), "removeScript"), rt = /* @__PURE__ */ t((e, t) => {
	if (We(t)) {
		let n = t.securityLevel;
		n === "antiscript" || n === "strict" || n === "sandbox" ? e = nt(e) : n !== "loose" && (e = ct(e), e = e.replace(/</g, "&lt;").replace(/>/g, "&gt;"), e = e.replace(/=/g, "&equals;"), e = st(e));
	}
	return e;
}, "sanitizeMore"), H = /* @__PURE__ */ t((t, n) => t && (t = n.dompurifyConfig ? e.sanitize(rt(t, n), n.dompurifyConfig).toString() : e.sanitize(rt(t, n), { FORBID_TAGS: ["style"] }).toString(), t), "sanitizeText"), it = /* @__PURE__ */ t((e, t) => typeof e == "string" ? H(e, t) : e.flat().map((e) => H(e, t)), "sanitizeTextOrArray"), at = /* @__PURE__ */ t((e) => V.test(e), "hasBreaks"), ot = /* @__PURE__ */ t((e) => e.split(V), "splitBreaks"), st = /* @__PURE__ */ t((e) => e.replace(/#br#/g, "<br/>"), "placeholderToBreak"), ct = /* @__PURE__ */ t((e) => e.replace(V, "#br#"), "breakToPlaceholder"), lt = /* @__PURE__ */ t((e) => {
	let t = "";
...
}, "getUrl"), ut = /* @__PURE__ */ t(function(...e) {
	let t = e.filter((e) => !isNaN(e));
	return Math.max(...t);
}, "getMax"), dt = /* @__PURE__ */ t(function(...e) {
	let t = e.filter((e) => !isNaN(e));
	return Math.min(...t);
}, "getMin"), ft = /* @__PURE__ */ t(function(e) {
	let t = e.split(/(,)/), n = [];
	for (let e = 0; e < t.length; e++) {
		let r = t[e];
		if (r === "," && e > 0 && e + 1 < t.length) {
			let i = t[e - 1], a = t[e + 1];
			pt(i, a) && (r = i + "," + a, e++, n.pop());
		}
		n.push(mt(r));
	}
	return n.join("");
}, "parseGenericTypes"), U = /* @__PURE__ */ t((e, t) => Math.max(0, e.split(t).length - 1), "countOccurrence"), pt = /* @__PURE__ */ t((e, t) => {
	let n = U(e, "~"), r = U(t, "~");
	return n === 1 && r === 1;
}, "shouldCombineSets"), mt = /* @__PURE__ */ t((e) => {
	let t = U(e, "~"), n = !1;
	if (t <= 1) return e;
...
}, "processSet"), ht = /* @__PURE__ */ t(() => window.MathMLElement !== void 0, "isMathMLSupported"), W = /\$\$(.*?)\$\$/g, G = /* @__PURE__ */ t((e) => (e.match(W)?.length ?? 0) > 0, "hasKatex"), gt = /* @__PURE__ */ t(async (e, t) => {
	let n = document.createElement("div");
	n.innerHTML = await vt(e, t), n.id = "katex-temp", n.style.visibility = "hidden", n.style.position = "absolute", n.style.top = "0", document.querySelector("body")?.insertAdjacentElement("beforeend", n);
	let r = {
		width: n.clientWidth,
		height: n.clientHeight
	};
	return n.remove(), r;
}, "calculateMathMLDimensions"), _t = /* @__PURE__ */ t(async (e, t) => {
	if (!G(e)) return e;
	if (!(ht() || t.legacyMathML || t.forceLegacyMathML)) return e.replace(W, "MathML is unsupported in this environment.");
	{
		let { default: n } = await import("./katex-DT5o3FVy.js"), r = t.forceLegacyMathML || !ht() && t.legacyMathML ? "htmlAndMathml" : "mathml";
...
}, "renderKatexUnsanitized"), vt = /* @__PURE__ */ t(async (e, t) => H(await _t(e, t), t), "renderKatexSanitized"), yt = {
	getRows: $e,
	sanitizeText: H,
	sanitizeTextOrArray: it,
	hasBreaks: at,
	splitBreaks: ot,
	lineBreakRegex: V,
	removeScript: nt,
	...
	getMax: ut,
	getMin: dt
}, bt = /* @__PURE__ */ t(function(e, t) {
	for (let n of t) e.attr(n[0], n[1]);
}, "d3Attrs"), xt = /* @__PURE__ */ t(function(e, t, n) {
	let r = /* @__PURE__ */ new Map();
	return n ? (r.set("width", "100%"), r.set("style", `max-width: ${t}px;`)) : (r.set("height", e), r.set("width", t)), r;
}, "calculateSvgSizeAttrs"), St = /* @__PURE__ */ t(function(e, t, n, r) {
	bt(e, xt(t, n, r));
}, "configureSvgSize"), Ct = /* @__PURE__ */ t(function(e, t, n, r) {
	let a = t.node().getBBox(), o = a.width, s = a.height;
	i.info(`SVG bounds: ${o}x${s}`, a);
	let c = 0, l = 0;
	i.info(`Graph bounds: ${c}x${l}`, e), c = o + n * 2, l = s + n * 2, i.info(`Calculated bounds: ${c}x${l}`), St(t, l, c, r);
...
t(wt, "cssStyleSheetToString");
var Tt = /* @__PURE__ */ t((e, t, n, r) => {
	let a = "";
  ...
  ${t}
`;
}, "getStyles"), Et = /* @__PURE__ */ t((e, t) => {
	t !== void 0 && (K[e] = t);
}, "addStylesForDiagram"), Dt = Tt, q = {};
n(q, {
	clear: () => Ot,
...
var J = "", Y = "", X = "", Z = /* @__PURE__ */ t((e) => H(e, z()), "sanitizeText"), Ot = /* @__PURE__ */ t(() => {
	J = "", X = "", Y = "";
}, "clear"), kt = /* @__PURE__ */ t((e) => {
	J = Z(e).replace(/^\s+/g, "");
}, "setAccTitle"), At = /* @__PURE__ */ t(() => J, "getAccTitle"), jt = /* @__PURE__ */ t((e) => {
	X = Z(e).replace(/\n\s+/g, "\n");
}, "setAccDescription"), Mt = /* @__PURE__ */ t(() => X, "getAccDescription"), Nt = /* @__PURE__ */ t((e) => {
	Y = Z(e);
}, "setDiagramTitle"), Pt = /* @__PURE__ */ t(() => Y, "getDiagramTitle"), Ft = i, It = r, Q = z, Lt = Fe, Rt = M, zt = /* @__PURE__ */ t((e) => H(e, Q()), "sanitizeText"), Bt = Ct, Vt = /* @__PURE__ */ t(() => q, "getCommonDb"), $ = {}, Ht = /* @__PURE__ */ t((e, t, n) => {
	$[e] && Ft.warn(`Diagram with id ${e} already registered. Overwriting.`), $[e] = t, n && Ze(e, n), Et(e, t.styles), t.injectUtils?.(Ft, It, Q, zt, Bt, Vt(), () => {});
}, "registerDiagram"), Ut = /* @__PURE__ */ t((e) => {
	if (e in $) return $[e];
	throw new Wt(e);
}, "getDiagram"), Wt = class extends Error {
	static {
...
//#endregion
export { x as $, G as A, zt as B, Qe as C, ce as D, Pe as E, vt as F, Lt as G, jt as H, Re as I, Ct as J, Nt as K, Ae as L, ft as M, Ht as N, lt as O, Xe as P, Ne as Q, j as R, Ut as S, We as T, kt as U, Me as V, Fe as W, Dt as X, Bt as Y, k as Z, Ge as _, Ot as a, o as at, z as b, St as c, Rt as d, b as et, De as f, N as g, Ke as h, gt as i, h as it, V as j, Ue as k, wt as l, B as m, Le as n, v as nt, q as o, Ye as p, je as q, T as r, _ as rt, yt as s, Je as t, y as tt, M as u, Mt as v, Pt as w, Q as x, At as y, H as z };

//# sourceMappingURL=chunk-DU6HZSFF-D6cGuXhs.js.map