...
import { m as n, p as r } from "./src-DjLrnVBU.js";
import { G as i, H as a, K as o, U as s, a as c, d as l, k as u, rt as d, s as f, v as p, w as ee, x as m, y as h } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { t as te } from "./channel-CiZ32joP.js";
import { c as g, g as _ } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as ne } from "./chunk-5VM5RSS4-Cr17nBXp.js";
import { i as re } from "./chunk-4HAMMTFA-wVMkDgvD.js";
import { t as v } from "./chunk-F27PBJKO-DanGKZor.js";
import { t as y } from "./chunk-XXDRQBXY-Ct3kz60r.js";
import { t as b } from "./chunk-POPQ4Y6H-BFKrin2m.js";
import { d as x, n as S, t as C, u as w } from "./mermaid.core-BCAu6WR7.js";
...
var T = "flowchart-", E = class {
	...
	addVertex(e, t, r, i, a, o, s = {}, c) {
		...
		if (p === void 0 && (t === void 0 && r === void 0 && i != null && n.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), p = {
			id: e,
			labelType: "text",
			domId: T + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, p)), this.vertexCounter++, t === void 0 ? p.text === void 0 && (p.text = e) : (this.config = m(), f = this.sanitizeText(t.text.trim()), p.labelType = t.type, f.startsWith("\"") && f.endsWith("\"") && (f = f.substring(1, f.length - 1)), p.text = f), r !== void 0 && (p.type = r), i?.forEach((e) => {
			p.styles.push(e);
		}), a?.forEach((e) => {
			p.classes.push(e);
			...
			if (l.shape) {
				...
				if (!re(l.shape)) throw Error(`No such shape: ${l.shape}.`);
				p.type = l?.shape;
			}
	...
	addSingleLink(e, t, r, i) {
		...
		if (o !== void 0 && (a.text = this.sanitizeText(o.text.trim()), a.text.startsWith("\"") && a.text.endsWith("\"") && (a.text = a.text.substring(1, a.text.length - 1)), a.labelType = this.sanitizeNodeLabelType(o.type)), r !== void 0 && (a.type = r.type, a.stroke = r.stroke, a.length = r.length > 10 ? 10 : r.length), i && !this.edges.some((e) => e.id === i)) a.id = i, a.isUserDefinedId = !0;
			...
			a.id = e.length === 0 ? g(a.start, a.end, {
				counter: 0,
				prefix: "L"
			}) : g(a.start, a.end, {
				counter: e.length + 1,
		...
		if (this.edges.length < (this.config.maxEdges ?? 500)) n.info("Pushing edge..."), this.edges.push(a);
...
You have to call mermaid.initialize.`);
	...
	setupToolTips(t) {
		let n = v();
		r(t).select("svg").selectAll("g.node").on("mouseover", (t) => {
			let i = r(t.currentTarget), a = i.attr("title");
			if (a === null) return;
			let o = t.currentTarget?.getBoundingClientRect();
			n.transition().duration(200).style("opacity", ".9"), n.text(i.attr("title")).style("left", window.scrollX + o.left + (o.right - o.left) / 2 + "px").style("top", window.scrollY + o.bottom + "px"), n.html(e.sanitize(a)), i.classed("hover", !0);
		}).on("mouseout", (e) => {
			n.transition().duration(500).style("opacity", 0), r(e.currentTarget).classed("hover", !1);
		});
	}
	clear(e = "gen-2") {
	...
	addSubGraph(e, r, i) {
		...
		if (l ??= u.inheritDir ? this.getDirection() ?? m().direction ?? void 0 : void 0, this.version === "gen-1") for (let e = 0; e < c.length; e++) c[e] = this.lookUpDomId(c[e]);
		...
		return n.info("Adding", d.id, d.nodes, d.dir), d.nodes = this.makeUniq(d, this.subGraphs).nodes, this.subGraphs.push(d), this.subGraphLookup.set(a, d), a;
	}
	getPosForId(e) {
	...
	getData() {
		let e = m(), n = [], r = [], i = this.getSubGraphs(), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map();
		for (let e of i) for (let t of e.nodes) this.subGraphLookup.has(t) && s.set(t, e.id);
		let c = /* @__PURE__ */ t((e) => this.subGraphLookup.get(e)?.metadata?.view === "collapsed", "isCollapsed"), l = /* @__PURE__ */ t((e) => {
		...
		this.getVertices().forEach((t) => {
			u.has(t.id) || this.addNodeFromVertex(t, n, a, o, e, e.look || "classic");
		});
		let f = this.getEdges();
		return f.forEach((t, n) => {
			let { arrowTypeStart: i, arrowTypeEnd: a } = this.destructEdgeType(t.type), o = [...f.defaultStyle ?? []], s = d.get(t.start) ?? t.start, c = d.get(t.end) ?? t.end;
			if (s === c && (d.has(t.start) || d.has(t.end))) return;
	...
	draw: /* @__PURE__ */ t(async function(e, t, r, i) {
		n.info("REF0:"), n.info("Drawing state diagram (v2)", t);
		let { securityLevel: a, flowchart: o, layout: s } = m();
		i.db.setDiagramId(t), n.debug("Before getData: ");
		let c = i.db.getData();
		n.debug("Data: ", c);
		let l = y(t, a), u = i.db.getDirection();
		c.type = i.type, c.layoutAlgorithm = w(s), c.layoutAlgorithm === "dagre" && s === "elk" && n.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), c.direction = u, c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = [
			"point",
			"circle",
			"cross"
		], c.diagramId = t, n.debug("REF1:", c), await x(c, l);
		let d = c.config.flowchart?.diagramPadding ?? 8;
		_.insertTitle(l, "flowchartTitleText", o?.titleTopMargin || 0, i.db.getDiagramTitle()), b(l, d, "flowchart", o?.useMaxWidth || !1);
	}, "draw")
}, O = (function() {
	var e = /* @__PURE__ */ t(function(e, t, n, r) {
		...
		124,
		125
	], o = [2, 2], s = [1, 13], c = [1, 14], l = [1, 15], u = [1, 16], d = [1, 23], f = [1, 25], p = [1, 26], ee = [1, 27], m = [1, 50], h = [1, 49], te = [1, 29], g = [1, 30], _ = [1, 31], ne = [1, 32], re = [1, 33], v = [1, 45], y = [1, 47], b = [1, 43], x = [1, 48], S = [1, 44], C = [1, 51], w = [1, 46], T = [1, 52], E = [1, 53], D = [1, 34], O = [1, 35], ie = [1, 36], ae = [1, 37], oe = [1, 38], k = [1, 58], A = [
		1,
		8,
		9,
		10,
		...
		parse: /* @__PURE__ */ t(function(e) {
			...
			var g = m.yylloc;
			o.push(g);
			var _ = m.options && m.options.ranges;
			...
			for (var v, y, b, x, S, C = {}, w, T, E, D;;) {
				if (b = r[r.length - 1], this.defaultActions[b] ? x = this.defaultActions[b] : (v ??= re(), x = s[b] && s[b][v]), x === void 0 || !x.length || !x[0]) {
					...
					O = m.showPosition ? "Parse error on line " + (l + 1) + ":\n" + m.showPosition() + "\nExpecting " + D.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (v == p ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(O, {
						text: m.match,
				...
				switch (x[0]) {
					case 1:
						r.push(v), a.push(m.yytext), o.push(m.yylloc), r.push(x[1]), v = null, y ? (v = y, y = null) : (u = m.yyleng, c = m.yytext, l = m.yylineno, g = m.yylloc, d > 0 && d--);
						break;
					case 2:
						...
						}, _ && (C._$.range = [o[o.length - (T || 1)].range[0], o[o.length - 1].range[1]]), S = this.performAction.apply(C, [
							c,
							u,
							l,
							h.yy,
...
O.parser = O;
var ie = O, ae = Object.assign({}, ie);
ae.parse = (e) => {
	let t = e.replace(/}\s*\n/g, "}\n");
	return ie.parse(t);
};
var oe = ae, k = /* @__PURE__ */ t((e, t) => {
	let n = te, r = n(e, "r"), i = n(e, "g"), a = n(e, "b");
	return d(r, i, a, t);
}, "fade"), A = /* @__PURE__ */ t((e) => `.label {
  ...
  .labelBkg {
    background-color: ${k(e.edgeLabelBackground, .5)};
    // background-color:
  }
  ...
  ${ne()}
`, "getStyles"), j = /* @__PURE__ */ t(({ defaultLayout: e, styles: n = A } = {}) => ({
	parser: oe,
	get db() {
		return new E();
	},
	...
	init: /* @__PURE__ */ t((t) => {
		t.flowchart ||= {};
		let n = u().layout ?? e ?? t.layout;
		n && i({ layout: n }), t.flowchart.arrowMarkerAbsolute = t.arrowMarkerAbsolute, i({ flowchart: { arrowMarkerAbsolute: t.arrowMarkerAbsolute } });
	}, "init")
}), "createFlowDiagram"), M = j();
//#endregion
export { M as n, A as r, j as t };

//# sourceMappingURL=chunk-SHT3W25Y-CJ2XbajO.js.map