...
import { R as r, h as i, p as a, r as o, s } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { t as c } from "./dist-CkY22sKw.js";
...
var Me = "[object RegExp]", O = "[object String]", k = "[object Number]", A = "[object Boolean]", j = "[object Arguments]", Ne = "[object Symbol]", Pe = "[object Date]", Fe = "[object Map]", Ie = "[object Set]", Le = "[object Array]", Re = "[object ArrayBuffer]", ze = "[object Object]", M = "[object DataView]", Be = "[object Uint8Array]", Ve = "[object Uint8ClampedArray]", He = "[object Uint16Array]", Ue = "[object Uint32Array]", We = "[object Int8Array]", Ge = "[object Int16Array]", Ke = "[object Int32Array]", qe = "[object Float32Array]", Je = "[object Float64Array]", Ye = typeof globalThis == "object" && globalThis || typeof window == "object" && window || typeof self == "object" && self || typeof global == "object" && global || (function() {
	return this;
})();
//#endregion
//#region node_modules/es-toolkit/dist/predicate/isBuffer.mjs
function N(e) {
	return Ye.Buffer !== void 0 && Ye.Buffer.isBuffer(e);
}
//#endregion
...
function $e(e, t) {
	return I(e, void 0, e, /* @__PURE__ */ new Map(), t);
}
function I(e, t, n, r = /* @__PURE__ */ new Map(), i = void 0) {
	let a = i?.(e, t, n, r);
	...
	if (Array.isArray(e)) {
		...
		r.set(e, t);
		for (let a = 0; a < e.length; a++) t[a] = I(e[a], a, n, r, i);
	...
	if (e instanceof Map) {
		...
		r.set(e, t);
		for (let [a, o] of e) t.set(a, I(o, a, n, r, i));
		return t;
	}
	if (e instanceof Set) {
		let t = /* @__PURE__ */ new Set();
		r.set(e, t);
		for (let a of e) t.add(I(a, void 0, n, r, i));
		return t;
	}
	...
	if (e instanceof DataView) {
		...
		return r.set(e, t), L(t, e, n, r, i), t;
	}
	...
	if (e instanceof Error) {
		...
		return r.set(e, t), t.message = e.message, t.name = e.name, t.stack = e.stack, t.cause = e.cause, t.constructor = e.constructor, L(t, e, n, r, i), t;
	}
	...
	return $e(e, (n, r, i, a) => {
		...
		if (typeof e == "object") {
			...
			switch (Object.prototype.toString.call(e)) {
				...
				case j: {
					let t = {};
					return L(t, e), t.length = e.length, t[Symbol.iterator] = e[Symbol.iterator], t;
				}
				default: return;
			}
		}
...
function V(e, t) {
	...
	return n.cache = new (V.Cache || Map)(), n;
}
V.Cache = Map;
//#endregion
...
function it(e) {
	if (P(e)) return e;
	if (Array.isArray(e) || F(e) || e instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && e instanceof SharedArrayBuffer) return e.slice(0);
...
function H(e, t, n, r) {
	if (P(e) && (e = Object(e)), typeof t != "object" || !t) return e;
	...
	for (let a = 0; a < i.length; a++) {
		...
		if (Qe(o)) continue;
		let s = t[o], c = e[o];
		if (R(s) && (s = { ...s }), R(c) && (c = { ...c }), N(s) && (s = nt(s)), Array.isArray(s)) {
			if (Array.isArray(c)) {
		...
		let l = n(c, s, o, e, t, r);
		l === void 0 ? Array.isArray(s) || z(c) && z(s) && (E(c) || E(s) || B(c) || B(s)) ? e[o] = H(c, s, n, r) : c == null && E(s) ? e[o] = H({}, s, n, r) : c == null && B(s) ? e[o] = nt(s) : (c === void 0 || s !== void 0) && (e[o] = s) : e[o] = l;
	}
	return e;
}
//#endregion
...
var st = c(), ct = {
	...
	curveStepAfter: ke,
	curveStepBefore: T
}, lt = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, ut = /* @__PURE__ */ e(function(e, t) {
...
}, "detectInit"), dt = /* @__PURE__ */ e(function(e, n = null) {
	try {
...
}, "detectDirective"), ft = /* @__PURE__ */ e(function(e) {
	return e.replace(i, "");
}, "removeDirectives"), pt = /* @__PURE__ */ e(function(e, t) {
...
e(_t, "calcLabelPosition");
var vt = /* @__PURE__ */ e((e, t = 2) => {
	let n = 10 ** t;
...
}, "calculatePoint"), yt = /* @__PURE__ */ e((e, n, r) => {
...
e(bt, "calcTerminalLabelPosition");
function K(e) {
	let t = "", n = "";
...
var xt = 0, St = /* @__PURE__ */ e(() => (xt++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + xt), "generateId");
function Ct(e) {
	let t = "";
...
e(Ct, "makeRandomHex");
var wt = /* @__PURE__ */ e((e) => Ct(e.length), "random"), Tt = /* @__PURE__ */ e(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, (e, t, n) => `${e}${t}${n.fontSize}${n.fontWeight}${n.fontFamily}${n.joinWith}`), Ot = V((e, t, n = "-", r) => {
	r = Object.assign({
		fontSize: 12,
		fontWeight: 400,
		fontFamily: "Arial",
...
e(q, "calculateTextHeight");
function J(e, t) {
	return Y(e, t).width;
}
e(J, "calculateTextWidth");
var Y = V((e, t) => {
	...
	static {
		e(this, "InitIDGenerator");
	}
}, X, At = /* @__PURE__ */ e(function(e) {
...
e($, "isLabelCoordinateInPath");
//#endregion
export { ce as $, Je as A, Ne as B, j as C, M as D, A as E, k as F, D as G, Ue as H, ze as I, w as J, ke as K, Me as L, Ke as M, We as N, Pe as O, Fe as P, fe as Q, Ie as R, N as S, Le as T, Be as U, He as V, Ve as W, we as X, Oe as Y, Te as Z, Dt as _, Ft as a, P as b, It as c, U as d, te as et, jt as f, Nt as g, ft as h, Q as i, Ge as j, qe as k, K as l, wt as m, q as n, ee as nt, Pt as o, Z as p, T as q, J as r, u as rt, St as s, Y as t, f as tt, Lt as u, B as v, Re as w, Ze as x, R as y, O as z };

//# sourceMappingURL=chunk-75Z2AOVW-bCXM9G_Z.js.map