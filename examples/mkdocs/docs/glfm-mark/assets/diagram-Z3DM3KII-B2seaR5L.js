...
import { H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { i as p } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as m } from "./chunk-JWPE2WC7-Ccb0QaC8.js";
import { f as h } from "./mermaid.core-BCAu6WR7.js";
...
var g = l.packet, _ = class {
	...
	for (let { start: s, end: c, bits: l, label: u } of e.blocks) {
		...
		for (c ??= s + (l ?? 1) - 1, l ??= c - s + 1, r = c, n.debug(`Packet block ${s} - ${r} with label ${u}`); i.length <= o + 1 && t.getPacket().length < v;) {
			let [e, n] = b({
				start: s,
				end: c,
				bits: l,
	...
	parse: /* @__PURE__ */ t(async (t) => {
		let r = await e("packet", t), i = x.parser?.yy;
		if (!(i instanceof _)) throw Error("parser.parser?.yy was not a PacketDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		n.debug(r), y(r, i);
	}, "parse")
...
//# sourceMappingURL=diagram-Z3DM3KII-B2seaR5L.js.map