...
import { H as n, J as r, K as i, U as a, a as o, d as s, s as c, v as l, w as u, x as d, y as f } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { t as p } from "./ordinal-BubEveRk.js";
...
q.parser = q;
var J = q, Y = [], X = [], Z = /* @__PURE__ */ new Map(), oe = /* @__PURE__ */ e(() => {
	Y = [], X = [], Z = /* @__PURE__ */ new Map(), o();
}, "clear"), se = class {
	constructor(e, t, n = 0) {
	...
	getNodes: /* @__PURE__ */ e(() => X, "getNodes"),
	getLinks: /* @__PURE__ */ e(() => Y, "getLinks"),
	getGraph: /* @__PURE__ */ e(() => ({
	...
	findOrCreateNode: /* @__PURE__ */ e((e) => {
		...
		let t = Z.get(e);
		return t === void 0 && (t = new le(e), Z.set(e, t), X.push(t)), t;
	}, "findOrCreateNode"),
	getAccTitle: f,
	setAccTitle: a,
	getAccDescription: l,
	...
	return n;
}, "findCentralNodeLayer"), fe = { draw: /* @__PURE__ */ e(function(n, i, a, o) {
	let { securityLevel: c, sankey: l } = d(), u = s.sankey, f;
	c === "sandbox" && (f = t("#i" + i));
	let m = t(c === "sandbox" ? f.nodes()[0].contentDocument.body : "body"), g = c === "sandbox" ? m.select(`[id="${i}"]`) : t(`[id="${i}"]`), _ = l?.width ?? u.width, v = l?.height ?? u.width, y = l?.useMaxWidth ?? u.useMaxWidth, b = l?.nodeAlignment ?? u.nodeAlignment, x = l?.prefix ?? u.prefix, S = l?.suffix ?? u.suffix, C = l?.showValues ?? u.showValues, w = l?.nodeWidth ?? u.nodeWidth ?? 10, T = l?.nodePadding ?? u.nodePadding ?? 12, E = l?.labelStyle ?? u.labelStyle ?? "legacy", D = l?.nodeColors ?? {}, O = o.db.getGraph(), k = $[b];
	P().nodeId((e) => e.id).nodeWidth(w).nodePadding(T + (C ? 15 : 0)).nodeAlign(k).extent([[0, 0], [_, v]])(O);
	let A = de(O.nodes), j = p(h), M = /* @__PURE__ */ e((e) => D[e] ?? j(e), "getNodeColor");
	g.append("g").attr("class", "nodes").selectAll(".node").data(O.nodes).join("g").attr("class", "node").attr("id", (e) => (e.uid = Q.next("node-")).id).attr("transform", function(e) {
...
${x}${Math.round(t * 100) / 100}${S}` : e, "getText"), F = /* @__PURE__ */ e((e) => E === "outlined" ? (e.layer ?? 0) < A ? {
	...
	if (z === "gradient") {
		let e = R.append("linearGradient").attr("id", (e) => (e.uid = Q.next("linearGradient-")).id).attr("gradientUnits", "userSpaceOnUse").attr("x1", (e) => e.source.x1).attr("x2", (e) => e.target.x0);
	...
	R.append("path").attr("d", K()).attr("stroke", B).attr("stroke-width", (e) => Math.max(1, e.width)), r(void 0, g, 0, y);
}, "draw") }, pe = /* @__PURE__ */ e((e) => e.replaceAll(/^[^\S\n\r]+|[^\S\n\r]+$/g, "").replaceAll(/([\n\r])+/g, "\n").trim(), "prepareTextForParsing"), me = /* @__PURE__ */ e((e) => `.label {
...
//# sourceMappingURL=sankeyDiagram-P5KCCOFB-btgEsg-v.js.map