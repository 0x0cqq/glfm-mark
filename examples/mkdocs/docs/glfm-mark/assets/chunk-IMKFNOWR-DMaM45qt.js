...
import { H as i, K as a, U as o, a as s, s as c, v as l, w as u, x as d, y as f } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { g as p, s as m } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as h } from "./chunk-F27PBJKO-DanGKZor.js";
import { t as g } from "./chunk-XXDRQBXY-Ct3kz60r.js";
import { t as _ } from "./chunk-POPQ4Y6H-BFKrin2m.js";
import { d as v } from "./mermaid.core-BCAu6WR7.js";
...
var y = (function() {
	...
	N.lexer = /* @__PURE__ */ (function() {
		return {
			...
			performAction: /* @__PURE__ */ t(function(e, n, r, i) {
				function a() {
					let t = n.yytext.indexOf("%%");
					if (t === 0) return !1;
					if (t > 0) {
						let r = n.yytext.slice(0, t), i = n.yytext.slice(t);
						i && e.lexer.unput(i), n.yytext = r;
					}
					return !0;
				}
				switch (t(a, "processId"), r) {
					case 0: return 38;
					case 1: return 40;
					case 2: return 39;
					case 3: return 44;
...
var b = y, x = "TB", S = "TB", C = "dir", w = "state", T = "root", E = "relation", D = "classDef", O = "style", k = "applyClass", A = "default", j = "divider", M = "fill:none", N = "fill: #333", P = "c", ee = "markdown", F = "normal", I = "rect", L = "rectWithTitle", te = "stateStart", ne = "stateEnd", R = "divider", re = "roundedWithTitle", ie = "note", ae = "noteGroup", z = "statediagram", oe = `${z}-state`, B = "transition", se = "note", ce = `${B} note-edge`, le = `${z}-${se}`, ue = `${z}-cluster`, de = `${z}-cluster-alt`, V = "parent", H = "note", fe = "state", U = "----", pe = `${U}${H}`, W = `${U}${V}`, G = /* @__PURE__ */ t((e, t = S) => {
	...
	draw: /* @__PURE__ */ t(async function(e, t, r, i) {
		...
		let c = i.db.getData(), l = g(t, a);
		c.type = i.type, c.layoutAlgorithm = s, c.nodeSpacing = o?.nodeSpacing || 50, c.rankSpacing = o?.rankSpacing || 50, c.markers = d().look === "neo" ? ["barbNeo"] : ["barb"], c.diagramId = t, await v(c, l);
		try {
			(typeof i.db.getLinks == "function" ? i.db.getLinks() : /* @__PURE__ */ new Map()).forEach((e, t) => {
				let r = typeof t == "string" ? t : typeof t?.id == "string" ? t.id : "", i = c.nodes.find((e) => e.id === r);
				if (!r) {
					n.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(t));
					return;
				}
				...
				if (a?.forEach((e) => {
					...
					n.warn("⚠️ Could not find node matching text:", r);
					return;
				}
				let s = o.parentNode;
				if (!s) {
					n.warn("⚠️ Node has no parent, cannot wrap:", r);
					return;
				}
				...
				s.replaceChild(u, o), u.appendChild(o), n.info("🔗 Wrapped node in <a> tag for:", r, e.url);
			});
		} catch (e) {
			n.error("❌ Error injecting clickable links:", e);
		}
		p.insertTitle(l, "statediagramTitleText", o?.titleTopMargin ?? 25, i.db.getDiagramTitle()), _(l, 8, z, o?.useMaxWidth ?? !0);
	}, "draw"),
	getDir: G
...
t(J, "stateDomId");
var he = /* @__PURE__ */ t((e, t, r, i, a, o, s, l) => {
	n.trace("items", t), t.forEach((t) => {
		switch (t.stmt) {
			case w:
				Z(e, t, r, i, a, o, s, l);
				break;
...
t(Y, "insertOrUpdateNode");
function X(e) {
	return e?.classes?.join(" ") ?? "";
}
t(X, "getClassesFromDbInfo");
function _e(e) {
	return e?.styles ?? [];
}
t(_e, "getStylesFromDbInfo");
var Z = /* @__PURE__ */ t((e, t, r, i, a, o, s, l) => {
	let u = t.id, f = r.get(u), p = X(f), m = _e(f), h = d();
	if (n.info("dataFetcher parsedItem", t, f, m), u !== "root") {
		let r = I;
		t.start === !0 ? r = te : t.start === !1 && (r = ne), t.type !== A && (r = t.type), K.get(u) || K.set(u, {
			id: u,
			shape: r,
		...
		if (f.shape === R && (f.label = ""), e && e.id !== "root" && (n.trace("Setting node ", u, " to be child of its parent ", e.id), f.parentId = e.id), f.centerLabel = !0, t.note) {
			let e = {
				labelStyle: "",
				shape: ie,
				label: t.note.text,
	...
	t.doc && (n.trace("Adding nodes children "), he(t, t.doc, r, i, a, !o, s, l));
}, "dataFetcher"), ve = /* @__PURE__ */ t(() => {
	K.clear(), q = 0;
}, "reset"), Q = {
	START_NODE: "[*]",
	START_TYPE: "start",
	...
	addState(e, t = A, r = void 0, i = void 0, a = void 0, o = void 0, s = void 0, l = void 0) {
		let u = e?.trim();
		if (!this.currentDocument.states.has(u)) n.info("Adding state ", u, i), this.currentDocument.states.set(u, {
			stmt: w,
			id: u,
			descriptions: [],
			type: t,
		...
		if (i && (n.info("Setting state description", u, i), (Array.isArray(i) ? i : [i]).forEach((e) => this.addDescription(u, e.trim()))), a) {
			let e = this.currentDocument.states.get(u);
			if (!e) throw Error(`State not found: ${u}`);
			e.note = a, e.note.text = c.sanitizeText(e.note.text, d());
		}
		o && (n.info("Setting state classes", u, o), (Array.isArray(o) ? o : [o]).forEach((e) => this.setCssClass(u, e.trim()))), s && (n.info("Setting state styles", u, s), (Array.isArray(s) ? s : [s]).forEach((e) => this.setStyle(u, e.trim()))), l && (n.info("Setting state styles", u, s), (Array.isArray(l) ? l : [l]).forEach((e) => this.setTextStyle(u, e.trim())));
	}
	clear(e) {
		this.nodes = [], this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.documents = { root: be() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = ye(), e || (this.links = /* @__PURE__ */ new Map(), s());
	}
	getState(e) {
	...
	setupToolTips(t) {
		let n = h();
		r(t).select("svg").selectAll("g.node, g.rough-node").on("mouseover", (t) => {
			let i = r(t.currentTarget), a = i.attr("title");
			if (a === null) return;
			let o = t.currentTarget?.getBoundingClientRect();
			n.transition().duration(200).style("opacity", ".9"), n.style("left", window.scrollX + o.left + (o.right - o.left) / 2 + "px").style("top", window.scrollY + o.bottom + "px"), n.html(e.sanitize(a)), i.classed("hover", !0);
		}).on("mouseout", (e) => {
	...
	getDirection() {
		return this.getDirectionStatement()?.value ?? x;
	}
	setDirection(e) {
...
//# sourceMappingURL=chunk-IMKFNOWR-DMaM45qt.js.map