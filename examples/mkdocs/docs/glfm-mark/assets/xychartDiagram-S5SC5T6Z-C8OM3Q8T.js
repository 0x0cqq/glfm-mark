...
import { D as n, H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f, z as p } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { t as m } from "./linear-CI4w6Fcm.js";
import { t as h } from "./ordinal-BubEveRk.js";
import { t as g } from "./init-CsQUQz36.js";
import { i as _ } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as v } from "./line-ZNUO6jjM.js";
import "./chunk-PWAF6VOD-CmtEB0s7.js";
import { t as y } from "./chunk-GMAD6QVW-BHOUSN3O.js";
import { f as b } from "./mermaid.core-BCAu6WR7.js";
...
e(D, "isLinearAxisData");
var O = class {
	constructor(e) {
		this.parentGroup = e;
	}
	static {
		e(this, "TextDimensionCalculatorWithFont");
	}
	getMaxDimension(e, t) {
...
e(P, "getChartTitleComponent");
var ne = .75, re = .5, ie = .35;
function F(e) {
	return {
		fontSize: e,
		markerSize: e * ne,
...
var ae = class {
	...
	calculateSpace(e) {
		...
		let { fontSize: t, markerSize: n, markerSpacing: r, itemSpacing: i } = F(this.chartConfig.legendFontSize), a = this.textDimensionCalculator.getMaxDimension(this.visiblePlots.map((e) => e.title), t), o = this.chartConfig.legendPadding * 2 + n + r + a.width, s = this.chartConfig.legendPadding * 2 + this.visiblePlots.length * t + (this.visiblePlots.length - 1) * i;
	...
	getDrawableElements() {
		...
		let { fontSize: e, markerSize: t, markerSpacing: n, itemSpacing: r } = F(this.chartConfig.legendFontSize), i = e + r, a = this.boundingRect.x + this.chartConfig.legendPadding, o = this.boundingRect.y + this.chartConfig.legendPadding, s = [], c = [];
		for (let [e, n] of this.visiblePlots.entries()) if (T(n)) s.push({
			x: a,
			y: o + e * i,
			width: t,
			height: t,
...
function I(e, t, n, r) {
	return new ae(new O(r), e, t, n);
}
e(I, "getChartLegendComponent");
var oe = class {
	constructor(e, t, n, r, i) {
	...
	getDrawableElements() {
		...
		for (let [t, n] of this.chartData.plots.entries()) switch (n.type) {
			case "line":
				{
					let r = new oe(n, this.xAxis, this.yAxis, this.chartConfig.chartOrientation, t);
					e.push(...r.getDrawableElement());
				}
				break;
			case "bar": {
				let r = new se(n, this.boundingRect, this.xAxis, this.yAxis, this.chartConfig.chartOrientation, t);
				e.push(...r.getDrawableElement());
			}
		}
		return e;
...
var ue = class {
	...
	static {
		e(this, "XYChartBuilder");
	}
	static build(e, t, n, r) {
		return new ue(e, t, n, r).getDrawableElement();
	}
}, L = 0, R, z = K(), B = G(), V = q(), H = B.plotColorPalette.split(",").map((e) => e.trim()), U = !1, W = !1;
function G() {
	let e = n(), t = s();
	return _(e.xyChart, t.themeVariables.xyChart);
}
e(G, "getChartDefaultThemeConfig");
function K() {
	let e = s();
	return _(l.xyChart, e.xyChart);
}
e(K, "getChartDefaultConfig");
function q() {
	return {
		yAxis: {
			type: "linear",
...
e(Y, "setTmpSVGG");
function fe(e) {
	e === "horizontal" ? z.chartOrientation = "horizontal" : z.chartOrientation = "vertical";
}
e(fe, "setOrientation");
function pe(e) {
	V.xAxis.title = J(e.text);
}
e(pe, "setXAxisTitle");
function X(e, t) {
	V.xAxis = {
...
e(X, "setXAxisRangeData");
function me(e) {
	V.xAxis = {
		type: "band",
		title: V.xAxis.title,
		categories: e.map((e) => J(e.text))
	}, U = !0;
}
e(me, "setXAxisBand");
function he(e) {
	V.yAxis.title = J(e.text);
}
e(he, "setYAxisTitle");
function Z(e, t) {
	V.yAxis = {
...
e(Z, "setYAxisRangeData");
function ge(e) {
	let t = Math.min(...e), n = Math.max(...e), r = D(V.yAxis) ? V.yAxis.min : Infinity, i = D(V.yAxis) ? V.yAxis.max : -Infinity;
	V.yAxis = {
		type: "linear",
		title: V.yAxis.title,
		min: Math.min(r, t),
...
e(ge, "setYAxisRangeFromPlotData");
function Q(e) {
	let t = [];
	if (e.length === 0) return t;
	if (!U) {
		let t = D(V.xAxis) ? V.xAxis.min : Infinity, n = D(V.xAxis) ? V.xAxis.max : -Infinity;
		X(Math.min(t, 1), Math.max(n, e.length));
	}
	if (E(V.xAxis) && e.length > V.xAxis.categories.length && (e = e.slice(0, V.xAxis.categories.length)), W || ge(e), E(V.xAxis) && (t = V.xAxis.categories.map((t, n) => [t, e[n]])), D(V.xAxis)) {
		let n = V.xAxis.min, r = V.xAxis.max;
...
e(Q, "transformDataWithoutCategory");
function $(e) {
	return H[e === 0 ? 0 : e % H.length];
}
e($, "getPlotColorFromPalette");
function _e(e, t) {
	let n = t.map((e) => e.value), r = t.map((e) => e.label ? J(e.label) : ""), i = Q(n), a = r.some((e) => e !== "");
	V.plots.push({
		type: "line",
		title: J(e.text),
		strokeFill: $(L),
...
e(ve, "setBarData");
function ye() {
	if (V.plots.length === 0) throw Error("No Plot to render, please provide a plot with some data");
	return V.title = d(), de.build(z, V, B, R);
}
e(ye, "getDrawableElem");
function be() {
	return B;
}
e(be, "getChartThemeConfig");
function xe() {
	return z;
}
e(xe, "getChartConfig");
...
var Ce = {
	...
	db: {
		...
		clear: /* @__PURE__ */ e(function() {
			o(), L = 0, z = K(), V = q(), B = G(), H = B.plotColorPalette.split(",").map((e) => e.trim()), U = !1, W = !1;
		}, "clear"),
		setAccTitle: a,
		getAccTitle: f,
		setDiagramTitle: i,
...
//# sourceMappingURL=xychartDiagram-S5SC5T6Z-C8OM3Q8T.js.map