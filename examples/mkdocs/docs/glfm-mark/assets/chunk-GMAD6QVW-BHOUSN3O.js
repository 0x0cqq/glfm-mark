...
import { m as r, p as i } from "./src-DjLrnVBU.js";
import { A as a, F as o, b as s, s as c, z as l } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { a as u } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { n as d, t as f } from "./chunk-PWAF6VOD-CmtEB0s7.js";
...
})), h = /* @__PURE__ */ e(p(), 1), ee = /* @__PURE__ */ e(m(), 1);
function g() {
	return {
		async: !1,
		breaks: !1,
...
var ne = (() => {
...
}, re = /^(?:[ \t]*(?:\n|$))+/, ie = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, ae = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, x = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, oe = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, S = /(?:[*+-]|\d{1,9}[.)])/, se = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, ce = y(se).replace(/bull/g, S).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), le = y(se).replace(/bull/g, S).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), C = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, ue = /^[^\n]+/, w = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, de = y(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", w).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), fe = y(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, S).getRegex(), T = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", E = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, pe = y("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", E).replace("tag", T).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), me = y(C).replace("hr", x).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", T).getRegex(), D = {
	...
	table: v,
	text: ue
}, he = y("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", x).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", T).getRegex(), ge = {
	...D,
	lheading: le,
	table: he,
	paragraph: y(C).replace("hr", x).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", he).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", T).getRegex()
}, _e = {
	...D,
...
}, ve = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, ye = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, be = /^( {2,}|\\)\n(?!\s*$)/, xe = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, O = /[\p{P}\p{S}]/u, k = /[\s\p{P}\p{S}]/u, Se = /[^\s\p{P}\p{S}]/u, Ce = y(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, k).getRegex(), we = /(?!~)[\p{P}\p{S}]/u, Te = /(?!~)[\s\p{P}\p{S}]/u, Ee = /(?:[^\s\p{P}\p{S}]|~)/u, De = y(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", ne ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), Oe = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, ke = y(Oe, "u").replace(/punct/g, O).getRegex(), Ae = y(Oe, "u").replace(/punct/g, we).getRegex(), je = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", Me = y(je, "gu").replace(/notPunctSpace/g, Se).replace(/punctSpace/g, k).replace(/punct/g, O).getRegex(), Ne = y(je, "gu").replace(/notPunctSpace/g, Ee).replace(/punctSpace/g, Te).replace(/punct/g, we).getRegex(), Pe = y("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, Se).replace(/punctSpace/g, k).replace(/punct/g, O).getRegex(), Fe = y(/\\(punct)/, "gu").replace(/punct/g, O).getRegex(), Ie = y(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), Le = y(E).replace("(?:-->|$)", "-->").getRegex(), Re = y("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", Le).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), A = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, ze = y(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", A).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), Be = y(/^!?\[(label)\]\[(ref)\]/).replace("label", A).replace("ref", w).getRegex(), Ve = y(/^!?\[(ref)\](?:\[\])?/).replace("ref", w).getRegex(), He = y("reflink|nolink(?!\\()", "g").replace("reflink", Be).replace("nolink", Ve).getRegex(), Ue = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, j = {
	_backpedal: v,
	anyPunctuation: Fe,
	autolink: Ie,
	blockSkip: De,
	...
	emStrongLDelim: Ae,
	url: y(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", Ue).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),
	_backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,
	del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,
	text: y(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", Ue).getRegex()
}, Ge = {
	...M,
	br: y(be).replace("{2,}", "*").getRegex(),
...
function F(e, t) {
	if (t) {
		if (b.escapeTest.test(e)) return e.replace(b.escapeReplace, qe);
	} else if (b.escapeTestNoEncode.test(e)) return e.replace(b.escapeReplaceNoEncode, qe);
	return e;
}
function Je(e) {
	try {
...
${c}` : c;
	...
	table(e) {
		...
		let n = Ye(t[1]), r = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split("\n") : [], a = {
			type: "table",
			raw: t[0],
			header: [],
			align: [],
		...
		if (n.length === r.length) {
			...
			for (let e of i) a.rows.push(Ye(e, a.header.length).map((e, t) => ({
				text: e,
				tokens: this.lexer.inline(e),
				header: !1,
				align: a.align[t]
	...
	link(e) {
		...
		if (t) {
			...
			return n = n.trim(), this.rules.other.startAngleBracket.test(n) && (n = this.options.pedantic && !this.rules.other.endAngleBracket.test(e) ? n.slice(1) : n.slice(1, -1)), Ze(t, {
	...
	reflink(e, t) {
		...
		if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
			...
			return Ze(n, e, n[0], this.lexer, this.rules);
		}
	}
	emStrong(e, t, n = "") {
	...
	inlineQueue;
	constructor(e) {
		this.tokens = [], this.tokens.links = Object.create(null), this.options = e || _, this.options.tokenizer = this.options.tokenizer || new L(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
			inLink: !1,
			inRawBlock: !1,
			top: !0
		};
...
`;
	...
	link({ href: e, title: t, tokens: n }) {
		let r = this.parser.parseInline(n), i = Je(e);
		if (i === null) return r;
		e = i;
		let a = "<a href=\"" + e + "\"";
	...
	parseMarkdown(e) {
		return (t, n) => {
			...
			if (i.hooks && (i.hooks.options = i, i.hooks.block = e), i.async) return (async () => {
				...
				let o = await (i.hooks ? await i.hooks.provideParser() : e ? V.parse : V.parseInline)(a, i);
			...
			try {
				...
				let r = (i.hooks ? i.hooks.provideParser() : e ? V.parse : V.parseInline)(n, i);
...
W.options = W.setOptions = function(e) {
	return U.setOptions(e), W.defaults = U.defaults, te(W.defaults), W;
}, W.getDefaults = g, W.defaults = _, W.use = function(...e) {
	return U.use(...e), W.defaults = U.defaults, te(W.defaults), W;
...
var G = typeof performance < "u" && typeof performance.now == "function", K = /* @__PURE__ */ n(() => G ? performance.now() : 0, "now"), q = "🧜 ", et = "Mermaid render", tt = "Mermaid", nt = {
	parse: "tertiary",
	prepare: "secondary",
	measure: "primary",
	layout: "primary-dark",
...
(class {
	...
	tickSync(e, t) {
		...
		try {
			...
			this.buckets[e] = (this.buckets[e] ?? 0) + (K() - n);
		}
	}
	async tick(e, t) {
		if (!this.enabled) return t();
	...
	begin(e) {
		...
		if (n ? n.children.push(t) : this.roots.push(t), this.stack.push(t), G && typeof performance.mark == "function") try {
			performance.mark(`${q}${e} \u25B6`);
		} catch {}
	}
	end() {
		if (!this.enabled) return;
		...
		if (!e) return;
		let t = K();
		if (e.duration = t - e.start, G && typeof performance.measure == "function") try {
			performance.measure(`${q}${e.name}`, {
				start: e.start,
				end: t,
				detail: { devtools: {
	...
	printSummary(e = this.report(), t) {
		if (!e) return;
		let r = e.duration, i = t && t !== e.name ? `${e.name} [${t}]` : e.name, a = ["ms        %    phase"], o = /* @__PURE__ */ n((e, t) => {
			let n = "  ".repeat(t), i = e.duration.toFixed(1).padStart(8), s = r > 0 ? `${(e.duration / r * 100).toFixed(0).padStart(3)}%` : "   -";
			a.push(`${i}  ${s}  ${n}${e.name}`);
			for (let n of e.children) o(n, t + 1);
			if (e.children.length > 0) {
				let t = e.children.reduce((e, t) => e + t.duration, 0), r = e.duration - t;
				if (r > .5) {
					let e = r.toFixed(1).padStart(8);
					a.push(`${e}       ${n}  (self)`);
				}
			}
		}, "walk");
		...
		console.log(`${q}mermaid render profile \xB7 ${i}
${a.join("\n")}`);
	}
}), globalThis.injected ??= {
...
n(at, "nonMarkdownToLines");
function ot(e, t = {}) {
	let r = it(e, t), i = W.lexer(r), a = [[]], o = 0;
	...
	return n(s, "processNode"), i.forEach((e) => {
...
n(ot, "markdownToLines");
function st(e) {
	return e ? `<p>${e.replace(/\\n|\n/g, "<br />")}</p>` : "";
}
n(st, "nonMarkdownToHTML");
...
n(lt, "splitTextToChars");
function ut(e, t) {
	return J(e, [], lt(t.content), t.type);
}
n(ut, "splitWordToFitWidth");
function J(e, t, n, r) {
...
n(Y, "splitLineToFitWidthRecursion");
function X(e, t) {
	t && e.attr("style", t);
}
n(X, "applyStyle");
var ft = 16384;
async function pt(e, t, n, r, i = !1, u = s()) {
	let d = e.append("foreignObject");
	d.attr("width", `${Math.min(10 * n, ft)}px`), d.attr("height", `${Math.min(10 * n, ft)}px`);
	let f = d.append("xhtml:div"), p = a(t.label) ? await o(t.label.replace(c.lineBreakRegex, "\n"), u) : l(t.label, u), m = t.isNode ? "nodeLabel" : "edgeLabel", h = f.append("span");
	return h.html(p), X(h, t.labelStyle), h.attr("class", `${m} ${r}`), X(f, t.labelStyle), f.style("display", "table-cell"), f.style("white-space", "nowrap"), f.style("line-height", "1.5"), n !== Infinity && (f.style("max-width", n + "px"), f.style("text-align", "center")), f.attr("xmlns", "http://www.w3.org/1999/xhtml"), i && f.attr("class", "labelBkg"), (await rt.measure(() => f.node().getBoundingClientRect())).width === n && (f.style("display", "table"), f.style("white-space", "break-spaces"), f.style("width", n + "px")), d.node();
}
n(pt, "addHtmlSpan");
...
n(ht, "computeDimensionOfText");
function gt(e, t, r, i = !1, a = !1) {
	...
	let u = 0;
	for (let t of r) {
		let r = /* @__PURE__ */ n((t) => mt(s, o, t) <= e, "checkWidth"), i = r(t) ? [t] : dt(t, r);
...
n($, "updateTextContentAndStyles");
async function _t(e, t = {}) {
	let n = [];
	e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (e, r, i) => (n.push((async () => {
		let n = `${r}:${i}`;
		return await d(n) ? await f(n, void 0, { class: "label-icon" }) : `<i class='${l(e, t).replace(":", " ")}'></i>`;
	})()), e));
	let r = await Promise.all(n);
	return e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, () => r.shift() ?? "");
}
n(_t, "replaceIconSubstring");
var vt = /* @__PURE__ */ n(async (e, t = "", { style: n = "", isTitle: o = !1, classes: s = "", useHtmlLabels: c = !0, markdown: l = !0, isNode: d = !0, width: f = 200, addSvgBackground: p = !1 } = {}, m) => {
	if (r.debug("XYZ createText", t, n, o, s, c, d, "addSvgBackground: ", p), c) {
		let r = l ? ct(t, m) : st(t), i = await _t(u(r), m), o = t.replace(/\\\\/g, "\\");
		return await pt(e, {
			isNode: d,
			label: a(t) ? o : i,
	...
	{
		let r = u(t.replace(/<br\s*\/?>/g, "<br/>")), a = gt(f, e, l ? ot(r.replace("<br>", "<br/>"), m) : at(r), t ? p : !1, !d);
		if (d) {
			...
			i(a).select("rect").attr("style", e.replace(/background:/g, "fill:"));
			let t = n.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
			i(a).select("text").attr("style", t);
		}
		return o ? i(a).selectAll("tspan.text-outer-tspan").classed("title-row", !0) : i(a).selectAll("tspan.text-outer-tspan").classed("row", !0), a;
	}
}, "createText");
//#endregion
export { $e as i, vt as n, rt as r, ht as t };

//# sourceMappingURL=chunk-GMAD6QVW-BHOUSN3O.js.map