...
import { $ as n, b as r, et as i, f as a, k as o, nt as s, x as c, z as l } from "./chunk-DU6HZSFF-D6cGuXhs.js";
...
import { t as u } from "./chunk-XXDRQBXY-Ct3kz60r.js";
import { t as d } from "./chunk-POPQ4Y6H-BFKrin2m.js";
import "./chunk-L3NEJ4N5-Y6gG0c2W.js";
import { d as f, u as p } from "./mermaid.core-BCAu6WR7.js";
...
var g = /* @__PURE__ */ new Uint8Array(16);
function _() {
	return crypto.getRandomValues(g);
}
//#endregion
//#region node_modules/uuid/dist/v4.js
function v(e, t, n) {
	return !t && !e && crypto.randomUUID ? crypto.randomUUID() : y(e, t, n);
}
function y(e, t, n) {
	e ||= {};
...
var x = b, S = 12, C = {
	...
	addNode(e, n, r, i) {
		...
		let s = c(), u = s.mindmap?.padding ?? a.mindmap.padding;
		switch (i) {
			case this.nodeType.ROUNDED_RECT:
			case this.nodeType.RECT:
			case this.nodeType.HEXAGON: u *= 2;
		}
		let d = {
			id: this.count++,
			nodeId: l(n, s),
	...
	decorateNode(e) {
		if (!e) return;
		let t = c(), n = this.nodes[this.nodes.length - 1];
		e.icon && (n.icon = l(e.icon, t)), e.class && (n.class = l(e.class, t));
	}
	type2Str(e) {
		switch (e) {
	...
	assignSections(e, t) {
		if (e.section = e.level === 0 ? void 0 : t, e.children) for (let [n, r] of e.children.entries()) {
			let i = e.level === 0 ? n % (S - 1) : t;
			this.assignSections(r, i);
		}
	}
	flattenNodes(t, n) {
		let r = c(), i = ["mindmap-node"];
		t.isRoot === !0 ? i.push("section-root", "section--1") : t.section !== void 0 && i.push(`section-${t.section}`), t.class && i.push(t.class);
		let a = i.join(" "), o = /* @__PURE__ */ e((e) => {
			let t = (r.theme?.toLowerCase() ?? "").includes("redux");
			switch (e) {
				case C.CIRCLE: return "mindmapCircle";
				case C.RECT: return "rect";
				case C.ROUNDED_RECT: return "rounded";
				case C.CLOUD: return "cloud";
				case C.BANG: return "bang";
				case C.HEXAGON: return "hexagon";
				case C.DEFAULT: return t ? "rounded" : "defaultMindmapNode";
				case C.NO_BORDER:
				default: return "rect";
			}
		}, "getShapeFromType"), s = {
	...
	getData() {
		let e = this.getMindmap(), n = c(), r = o().layout !== void 0, i = n;
		...
		let a = [], s = [];
		this.flattenNodes(e, a), this.generateEdges(e, s), t.debug(`getData: processed ${a.length} nodes and ${s.length} edges`);
...
}, T = { draw: /* @__PURE__ */ e(async (e, n, i, o) => {
	t.debug("Rendering mindmap diagram\n" + e);
	let s = o.db, c = s.getData(), l = u(n, c.config.securityLevel);
	if (c.type = o.type, c.layoutAlgorithm = p(c.config.layout, { fallback: "cose-bilkent" }), c.diagramId = n, !s.getMindmap()) return;
	c.nodes.forEach((e) => {
	...
	let { themeVariables: m } = r(), { useGradient: h, gradientStart: g, gradientStop: _ } = m;
	if (h && g && _) {
	...
	d(l, c.config.mindmap?.padding ?? a.mindmap.padding, "mindmapDiagram", c.config.mindmap?.useMaxWidth ?? a.mindmap.useMaxWidth);
}, "draw") }, E = /* @__PURE__ */ e((e) => {
	let { theme: t, look: r } = e, a = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], s(e["lineColor" + t]) ? e["lineColor" + t] = i(e["lineColor" + t], 20) : e["lineColor" + t] = n(e["lineColor" + t], 20);
	...
	return a;
}, "genSections"), D = /* @__PURE__ */ e((e, t, n) => {
	let r = "";
	for (let i = 0; i < e; i++) r += `
  ...
  ${e.useGradient && n && e.mainBkg ? D(e.THEME_COLOR_LIMIT, n, e.mainBkg) : ""}
`;
	}, "getStyles")
};
//#endregion
...
//# sourceMappingURL=mindmap-definition-YA3MSWOX-BrWfsQR8.js.map