...
import { n } from "./mermaid-parser.core-naGH13HF.js";
import { n as r } from "./chunk-Y2CYZVJY-i11wjrBe.js";
import { m as i, p as a } from "./src-DjLrnVBU.js";
import { H as o, J as s, K as c, U as l, a as u, b as d, f, v as p, w as m, x as h, y as g, z as _ } from "./chunk-DU6HZSFF-D6cGuXhs.js";
import { c as v, i as y } from "./chunk-75Z2AOVW-bCXM9G_Z.js";
import { t as b } from "./chunk-JWPE2WC7-Ccb0QaC8.js";
import { i as x, r as S, t as C } from "./chunk-PWAF6VOD-CmtEB0s7.js";
import { n as w } from "./chunk-GMAD6QVW-BHOUSN3O.js";
import { t as T } from "./cytoscape.esm-UtN2hSik.js";
import { f as E } from "./mermaid.core-BCAu6WR7.js";
...
var D = /* @__PURE__ */ t(((e, t) => {
					...
					for (var te = E - 1, H = 0, ne = 2 ** -52, re = 2 ** -966; E > 0;) {
						...
						switch (U++, W) {
							case 1:
								...
								n[E - 2] = 0;
								for (var q = E - 2; q >= U; q--) {
									var ae = r.hypot(this.s[q], K), J = this.s[q] / ae, Y = K / ae;
									if (this.s[q] = ae, q !== U && (K = -Y * n[q - 1], n[q - 1] = J * n[q - 1]), o) for (var X = 0; X < this.n; X++) ae = J * this.V[X][q] + Y * this.V[X][E - 1], this.V[X][E - 1] = -Y * this.V[X][q] + J * this.V[X][E - 1], this.V[X][q] = ae;
								}
								break;
							case 2:
								var oe = n[U - 1];
					...
					c.handleConstraints = function(e) {
						...
						if (i.ENFORCE_CONSTRAINTS) {
							...
							if (t.alignmentConstraint) {
								...
								if (t.alignmentConstraint.horizontal) for (var q = t.alignmentConstraint.horizontal, ae = function(e) {
									var t = /* @__PURE__ */ new Set();
							...
							t.relativePlacementConstraint && (function() {
								...
								try {
									for (var J = ee.keys()[Symbol.iterator](), Y; !(K = (Y = J.next()).done); K = !0) {
										var G = Y.value;
										ie(G);
									}
								} catch (e) {
			...
			var t = {
					...
					e.exports = function() {
						...
						return r(e, [{
							...
							value: function() {
								...
								var d = void 0, f = !1;
								if (n.layoutUtilities && t.packComponents && (d = n.layoutUtilities("get"), d ||= n.layoutUtilities(), f = !0), r.nodes().length > 0) {
									if (f) {
				...
				657: ((e, t, n) => {
					...
					e.exports = { spectralLayout: function(e) {
						...
						var ie = l.keys(), K = t.getElementById(ie.next().value), q = K.position(), ae = K.outerWidth();
						if (f.push(q.x), p.push(q.y), y == 2) {
							var J = t.getElementById(ie.next().value).outerWidth();
							f.push(q.x + ae / 2 + J / 2 + e.idealEdgeLength), p.push(q.y);
						}
						return U = {
							nodeIndexes: l,
							xCoords: f,
...
}, "isArchitectureJunction"), re = /* @__PURE__ */ r((e, t) => {
	let [n, r] = [e, t].sort();
	return `${JSON.stringify(n)}-${JSON.stringify(r)}`;
}, "architectureGroupAlignmentKey"), U = /* @__PURE__ */ r((e) => e.data(), "edgeData"), W = /* @__PURE__ */ r((e) => e.data(), "nodeData"), G = f.architecture, ie = class {
	constructor() {
	...
	getServices() {
		return [...this.nodes.values()].filter(H);
	}
	...
	getJunctions() {
		return [...this.nodes.values()].filter(ne);
	}
	getNodes() {
		...
		if (this.dataStructures === void 0) {
			...
			for (let [n, r] of this.nodes.entries()) {
				...
				for (let t of r.edges) {
					...
					if (r && a && r !== a) {
						let n = te(t.lhsDir, t.rhsDir);
						n !== "bend" && e.set(re(r, a), n);
					}
					if (t.lhsId === n) {
			...
			let n = /* @__PURE__ */ new Set(), i = new Set(t.keys()), a = /* @__PURE__ */ r((e) => {
				...
				for (; a.length > 0;) {
					...
					if (e) {
						...
						let [c, l] = s;
						o.forEach((e, t) => {
							n.has(e) || (r.set(e, V([c, l], t)), a.push(e));
						});
					}
				}
				return r;
	...
	parse: /* @__PURE__ */ r(async (e) => {
		...
		i.debug(t);
		let r = q.parser?.yy;
		if (!(r instanceof ie)) throw Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		K(t, r);
	}, "parse")
}, ae = /* @__PURE__ */ r((e) => `
  .edge {
...
var Y = /* @__PURE__ */ r((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), X = {
	...
	await Promise.all(t.edges().map(async (t) => {
		...
		if (d && (F(l) ? y += l === "L" ? -E : E : b += l === "T" ? -E : E + 18), g && (F(p) ? C += p === "L" ? -E : E : T += p === "T" ? -E : E + 18), !d && n.getNode(a)?.type === "junction" && (F(l) ? y += l === "L" ? o : -o : b += l === "T" ? o : -o), !g && n.getNode(f)?.type === "junction" && (F(p) ? C += p === "L" ? o : -o : T += p === "T" ? o : -o), t[0]._private.rscratch) {
			...
			if (m) {
				let e = F(p) ? M[p](C, s) : C - c, n = I(p) ? M[p](T, s) : T - c;
...
}, "drawEdges"), Z = /* @__PURE__ */ r(async function(e, t, n, r) {
...
}, "drawGroups"), se = /* @__PURE__ */ r(async function(e, t, n, r) {
	let i = h();
	for (let a of n) {
	...
	return 0;
}, "drawServices"), ce = /* @__PURE__ */ r(function(e, t, n, r) {
	n.forEach((n) => {
...
r(he, "getRelativeConstraints");
function ge(e, t, n, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		...
		d.remove(), fe(n, f), le(e, f, s), ue(t, f, s), pe(o, f);
		let p = s.getLayoutHints(), m = me(s, c, l, p), h = he(c, s, p), g = s.getConfigField("iconSize"), _ = s.getConfigField("idealEdgeLengthMultiplier") * g, v = .5 * g, y = s.getConfigField("edgeElasticity"), b = s.getConfigField("seed"), x = f.layout({
			name: "fcose",
			quality: "proof",
...
var _e = {
	...
	renderer: { draw: /* @__PURE__ */ r(async (e, t, n, r) => {
		...
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await se(i, p, a, t), ce(i, p, o, t);
		let h = await ge(a, o, c, l, i, u);
		await oe(f, h, i, t), await Z(m, h, i, t), de(i, h), s(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: ae
};
//#endregion
...
//# sourceMappingURL=architectureDiagram-5GKGNRK7-uI_zS1bA.js.map